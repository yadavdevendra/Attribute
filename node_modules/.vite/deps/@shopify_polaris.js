...
function sanitizeCustomProperties(styles134) {
  const nonNullValues = Object.entries(styles134).filter(([_, value]) => value != null);
...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react460.useCallback)((event) => {
    if (disabled) {
...
function useIsAfterInitialMount() {
  const [isAfterInitialMount, setIsAfterInitialMount] = (0, import_react461.useState)(false);
...
function VisuallyHidden({
  ...
  return import_react462.default.createElement("span", {
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react463.default.createElement("svg", {
    viewBox: "0 0 44 44",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react463.default.createElement("path", {
    d: "M15.542 1.487A21.507 21.507 0 00.5 22c0 11.874 9.626 21.5 21.5 21.5 9.847 0 18.364-6.675 20.809-16.072a1.5 1.5 0 00-2.904-.756C37.803 34.755 30.473 40.5 22 40.5 11.783 40.5 3.5 32.217 3.5 22c0-8.137 5.3-15.247 12.942-17.65a1.5 1.5 0 10-.9-2.863z"
  })) : import_react463.default.createElement("svg", {
    viewBox: "0 0 20 20",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react463.default.createElement("path", {
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react463.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react463.default.createElement(import_react463.default.Fragment, null, import_react463.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react463.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function usePortalsManager() {
  const portalsManager = (0, import_react464.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react465.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react465.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react466.default.createElement("div", {
...
function wrapWithComponent(element, Component9, props) {
  ...
  return isElementOfType(element, Component9) ? element : import_react467.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react467.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react467.Children.toArray(children2).filter((child) => (0, import_react467.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react468.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react468.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var ScrollableContext = (0, import_react469.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react470.useRef)(null);
  const scrollToPosition = (0, import_react470.useContext)(ScrollableContext);
  (0, import_react470.useEffect)(() => {
  ...
  return import_react470.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react471.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
  ...
  render() {
    ...
    return import_react471.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react471.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react471.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react472.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react472.default.createElement("div", {
      ...
      style,
      ref: this.setOverlay
    }, import_react472.default.createElement(EventListener, {
      event: "resize",
...
function Pane({
  ...
  return fixed ? import_react474.default.createElement("div", {
    style,
    className
  }, content) : import_react474.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react475.PureComponent {
  constructor(props) {
    super(props);
    this.context = void 0;
    this.state = {
    ...
    this.contentNode = (0, import_react475.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react475.default.createElement("div", {
        id,
      ...
      return import_react475.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react475.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react475.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react475.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: this.handleEscape
      }), import_react475.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
        onFocus: this.handleFocusFirstItem
      }), import_react475.default.createElement("div", {
        className: styles6.Wrapper
      }, content), import_react475.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react475.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react475.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react475.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react476.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react476.useState)();
  const overlayRef = (0, import_react476.useRef)(null);
  const activatorContainer = (0, import_react476.useRef)(null);
  ...
  (0, import_react476.useImperativeHandle)(ref, () => {
    return {
      forceUpdatePosition
    };
  });
  const setAccessibilityAttributes = (0, import_react476.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react476.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react476.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react476.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react476.Children.only(activator), portal2);
});
...
function TextStyle({
  ...
  return import_react477.default.createElement(Element2, {
    className
  }, children2);
}
...
var WithinFilterContext = (0, import_react478.createContext)(false);
...
function useI18n() {
  const i18n = (0, import_react479.useContext)(I18nContext);
  if (!i18n) {
...
function Pip({
  ...
  return import_react480.default.createElement("span", {
    className
  }, import_react480.default.createElement(VisuallyHidden, null, accessibilityLabel));
}
...
function Icon({
  ...
  const contentMarkup = {
    function: import_react481.default.createElement(SourceComponent, {
      className: styles13.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react481.default.createElement("div", {
      className: styles13.Placeholder
    }),
    external: import_react481.default.createElement("img", {
  ...
  return import_react481.default.createElement("span", {
    className
  }, import_react481.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react482.useContext)(WithinFilterContext);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && import_react482.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = import_react482.default.createElement("span", {
      className: styles11.PipContainer
    }, import_react482.default.createElement(Pip, {
      progress,
      status,
      accessibilityLabelOverride: accessibilityLabel
    }));
  }
  return import_react482.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && import_react482.default.createElement("span", {
    className: styles11.Icon
  }, import_react482.default.createElement(Icon, {
    source: icon
  })), children2 && import_react482.default.createElement("span", null, children2));
}
Badge.Pip = Pip;
...
function useLink() {
  return (0, import_react483.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react484.memo)((0, import_react484.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react484.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react484.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = import_react485.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react485.default.createElement("span", {
    className: styles9.ContentBlock
  }, import_react485.default.createElement("span", {
    className: styles9.ContentBlockInner
  }, contentText), import_react485.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react485.default.createElement("span", {
    className: styles9.Suffix
  }, import_react485.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react485.default.createElement("span", {
    className: styles9.Suffix
  }, suffix);
  const textMarkup = import_react485.default.createElement("span", {
    className: styles9.Text
  }, contentMarkup);
  const contentElement = import_react485.default.createElement("span", {
    className: styles9.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react485.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react485.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react485.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react485.default.createElement(import_react485.default.Fragment, null, scrollMarkup, control);
}
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    }, import_react486.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  const titleMarkup = section.title ? import_react486.default.createElement("p", {
  ...
  const sectionMarkup = import_react486.default.createElement("div", {
    className
  }, titleMarkup, import_react486.default.createElement("ul", {
    className: styles9.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react486.default.createElement("li", {
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react487.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react487.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react487.default.createElement(import_react487.default.Fragment, null, import_react487.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react487.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react487.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react488.default.createElement("a", commonProps, children2) : import_react488.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react488.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? import_react489.default.createElement("span", {
  ...
  }, import_react489.default.createElement(Icon, {
    source: loading ? "placeholder" : getDisclosureIconSource(disclosure)
  }))) : null;
  const iconSource = isIconSource(icon) ? import_react489.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? import_react489.default.createElement("span", {
    className: classNames(styles3.Icon, loading && styles3.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react489.default.createElement("span", {
    className: classNames(styles3.Text, removeUnderline && styles3.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react489.default.createElement("span", {
    className: styles3.Spinner
  }, import_react489.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react489.useState)(false);
  const toggleDisclosureActive = (0, import_react489.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = import_react489.default.createElement("button", {
      type: "button",
    ...
    }, import_react489.default.createElement("span", {
      className: styles3.Icon
    }, import_react489.default.createElement(Icon, {
      source: SvgCaretDownMinor
    })));
    connectedDisclosureMarkup = import_react489.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react489.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react489.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react489.default.createElement("span", {
    className: styles3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react489.default.createElement("div", {
...
function buttonFrom({
  ...
  return import_react490.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function ButtonGroup({
  ...
  const contents = elementChildren(children2).map((child, index) => import_react492.default.createElement(Item2, {
    button: child,
    key: index
  }));
...
// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react494.memo)(function Stack2({
  children: children2,
  vertical,
  spacing: spacing3,
  distribution,
...
function Heading({
  ...
  return import_react495.default.createElement(Element2, {
...
function Header({
  ...
  const actionMarkup = actions ? import_react496.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react496.isValidElement)(title) ? title : import_react496.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react496.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react496.default.createElement(Stack.Item, {
    fill: true
...
function Subheading({
  ...
  return import_react497.default.createElement(Element2, {
...
function Section3({
  ...
  const actionMarkup = actions ? import_react498.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = typeof title === "string" ? import_react498.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react498.default.createElement("div", {
    className: styles2.SectionHeader
  }, actionMarkup ? import_react498.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react498.default.createElement(Stack.Item, {
    fill: true
...
var Card = function Card2({
  ...
  const headerMarkup = title || actions ? import_react500.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react500.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react500.default.createElement(import_react500.default.Fragment, null, import_react500.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react500.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react500.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react500.default.createElement("div", {
    className: classNames(styles2.Footer, footerActionAlignment === "left" && styles2.LeftJustified)
  }, footerActionAlignment === "right" ? import_react500.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react500.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react500.default.createElement(WithinContentContext.Provider, {
    value: true
...
function SettingAction({
  ...
  }, children2), import_react501.default.createElement("div", {
...
function Image({
  ...
  return import_react502.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const i18n = useI18n();
  const isAfterInitialMount = useIsAfterInitialMount();
  const [status, setStatus] = (0, import_react503.useState)(Status.Pending);
  (0, import_react503.useEffect)(() => {
    setStatus(Status.Pending);
  }, [source]);
  const handleError = (0, import_react503.useCallback)(() => {
    setStatus(Status.Errored);
    if (onError) {
      onError();
    }
  }, [onError]);
  const handleLoad = (0, import_react503.useCallback)(() => {
  ...
  const textClassName = classNames(styles19.Text, ((initials === null || initials === void 0 ? void 0 : initials.length) || 0) > 2 && styles19.long);
  const imageClassName = classNames(styles19.Image, status !== Status.Loaded && styles19.hidden);
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react503.default.createElement(Image, {
  ...
  const avatarBody = customer || !initials ? import_react503.default.createElement("path", {
    fill: "currentColor",
  ...
  }) : import_react503.default.createElement("text", {
  ...
  const svgMarkup = hasImage ? null : import_react503.default.createElement("span", {
    className: styles19.Initials
  }, import_react503.default.createElement("svg", {
    className: styles19.Svg,
    viewBox: "0 0 40 40"
  }, avatarBody));
  return import_react503.default.createElement("span", {
    "aria-label": label,
    role: "img",
    className
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react504.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react504.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react504.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react504.default.createElement("div", null, import_react504.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react504.default.createElement("div", {
    className: styles.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react504.default.createElement(Card, {
    sectioned: true
  }, import_react504.default.createElement(SettingAction, {
    action: actionElement
  }, import_react504.default.createElement(Stack, null, avatarMarkup, import_react504.default.createElement(Stack.Item, {
    fill: true
...
function RollupActions({
  ...
  const activatorMarkup = import_react505.default.createElement("div", {
    className: styles21.RollupActivator
  }, import_react505.default.createElement(Button, {
    outline: true,
  ...
  return import_react505.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react505.default.createElement(ActionList, {
    items,
    sections,
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react506.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return import_react506.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react506.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react507.useState)(null);
  const id = useUniqueId("TooltipContent");
  const activatorContainer = (0, import_react507.useRef)(null);
  const mouseEntered = (0, import_react507.useRef)(false);
  ...
  const handleKeyUp = (0, import_react507.useCallback)((event) => {
    if (event.key !== "Escape")
      return;
    onClose === null || onClose === void 0 ? void 0 : onClose();
    handleBlur();
  }, [handleBlur, onClose]);
  const portal2 = activatorNode ? import_react507.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react507.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react507.default.createElement(WrapperComponent, {
    onFocus: () => {
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react508.useRef)(null);
  ...
  const buttonMarkup = import_react508.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2);
  const actionMarkup = helpText ? import_react508.default.createElement(Tooltip, {
    content: helpText
  }, buttonMarkup) : buttonMarkup;
  return import_react508.default.createElement("span", {
...
function MenuGroup({
  ...
  const handleClose = (0, import_react509.useCallback)(() => {
    onClose(title);
  }, [onClose, title]);
  const handleOpen = (0, import_react509.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  const handleClick = (0, import_react509.useCallback)(() => {
    if (onClick) {
      onClick(handleOpen);
    } else {
      handleOpen();
  ...
  const handleOffsetWidth = (0, import_react509.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = import_react509.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  return import_react509.default.createElement(Popover2, {
    active: Boolean(active),
    activator: popoverActivator,
    preferredAlignment: "left",
    onClose: handleClose,
    hideOnPrint: true
  }, import_react509.default.createElement(ActionList, {
    items: actions,
    sections,
    onActionAnyItem: handleClose
  }), details && import_react509.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react510.useRef)(null);
  const menuGroupWidthRef = (0, import_react510.useRef)(0);
  const availableWidthRef = (0, import_react510.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react510.useRef)(0);
  const timesMeasured = (0, import_react510.useRef)(0);
  const actionWidthsRef = (0, import_react510.useRef)([]);
  const rollupActiveRef = (0, import_react510.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react510.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react510.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react510.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react510.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react510.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react510.useCallback)(() => {
  ...
  const measureActions = (0, import_react510.useCallback)(() => {
  ...
  const handleResize = (0, import_react510.useMemo)(() => debounce(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react510.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react510.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react510.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react510.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  ...
  }, groupedActionsMarkup, import_react510.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  return import_react511.default.createElement("div", {
    className: actionMenuClassNames
  }, rollup ? import_react511.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react511.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
// node_modules/@shopify/polaris/build/esm/components/Box/Box.js
var Box = (0, import_react512.forwardRef)(({
  as = "div",
  background,
  border,
  borderBottom,
  ...
  const className = classNames(styles26.Box);
  return (0, import_react512.createElement)(as, {
    className,
    ref,
...
var AlphaCard = ({
  ...
  return import_react513.default.createElement(Box, Object.assign({
    background,
    padding,
    shadow
  }, hasBorderRadius && {
...
// node_modules/@shopify/polaris/build/esm/components/AlphaStack/AlphaStack.js
var import_react514 = __toESM(require_react());

// node_modules/@shopify/polaris/build/esm/components/AlphaStack/AlphaStack.scss.js
var styles27 = {
  "AlphaStack": "Polaris-AlphaStack",
  "fullWidth": "Polaris-AlphaStack--fullWidth"
};
...
var AlphaStack = ({
  ...
  const className = classNames(styles27.AlphaStack, fullWidth && styles27.fullWidth);
  const style = {
    "--pc-stack-align": align ? `${align}` : "",
    ...spacing3 ? {
      "--pc-stack-spacing": `var(--p-space-${spacing3})`
    } : {}
  };
...
var ComboboxTextFieldContext = (0, import_react515.createContext)(void 0);
var ComboboxListboxContext = (0, import_react515.createContext)({});
var ComboboxListboxOptionContext = (0, import_react515.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react516.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react516.useContext)(ComboboxListboxContext);
  return context;
}
...
var ListboxContext = (0, import_react517.createContext)(void 0);
var WithinListboxContext = (0, import_react517.createContext)(false);
var ActionContext = (0, import_react517.createContext)(false);
...
function InlineError({
  ...
  return import_react518.default.createElement("div", {
    ...
    className: styles34.InlineError
  }, import_react518.default.createElement("div", {
    className: styles34.Icon
  }, import_react518.default.createElement(Icon, {
...
function Choice({
  ...
  const className = classNames(styles33.Choice, labelHidden && styles33.labelHidden, disabled && styles33.disabled);
  const labelMarkup = import_react519.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
    onMouseOut
  }, import_react519.default.createElement("span", {
    className: styles33.Control
  }, children2), import_react519.default.createElement("span", {
    className: styles33.Label
  }, label));
  const helpTextMarkup = helpText ? import_react519.default.createElement("div", {
    className: styles33.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react519.default.createElement("div", {
    className: styles33.Error
  }, import_react519.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react519.default.createElement("div", {
    className: styles33.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react519.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react520.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react520.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react520.useState)(false);
  const isWithinListbox = (0, import_react520.useContext)(WithinListboxContext);
  (0, import_react520.useImperativeHandle)(ref, () => ({
    focus: () => {
  ...
  const wrapperClassName = classNames(styles32.Checkbox, error && styles32.error);
  const backdropClassName = classNames(styles32.Backdrop, mouseOver && styles32.hover);
  ...
  const inputClassName = classNames(styles32.Input, isIndeterminate && styles32["Input-indeterminate"], keyFocused && styles32.keyFocused);
  return import_react520.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react520.default.createElement("span", {
    className: wrapperClassName
  }, import_react520.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react520.default.createElement("span", {
    className: backdropClassName,
    onClick: stopPropagation,
    onKeyUp: stopPropagation
  }), import_react520.default.createElement("span", {
    className: styles32.Icon
  }, import_react520.default.createElement(Icon, {
    source: iconSource
  }))));
});
function noop4() {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react521.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react521.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react521.useContext)(ActionContext);
  const textOptionClassName = classNames(styles31.TextOption, selected && !allowMultiple && styles31.selected, disabled && styles31.disabled, allowMultiple && styles31.allowMultiple, isAction && styles31.isAction);
  return import_react521.default.createElement("div", {
    className: textOptionClassName
  }, import_react521.default.createElement("div", {
    className: styles31.Content
  }, allowMultiple && !isAction ? import_react521.default.createElement("div", {
    className: styles31.Checkbox
  }, import_react521.default.createElement(Checkbox, {
    disabled,
    checked: selected,
    label: children2
  })) : children2));
...
function useListbox() {
  const listbox = (0, import_react522.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react523.memo)(function LoadingOption({
  children: children2,
  ...
  (0, import_react523.useEffect)(() => {
    setLoading(label);
    return () => {
      setLoading(void 0);
    };
  }, [label, setLoading]);
  return import_react523.default.createElement("li", {
    className: styles35.ListItem,
    role: "presentation"
  }, children2 ? children2 : import_react523.default.createElement("div", {
    className: styles35.Loading
  }, import_react523.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var SectionContext = (0, import_react524.createContext)(null);
...
function Section4({
  ...
  return import_react525.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react525.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react525.default.createElement("ul", {
    role: "group",
    "aria-labelledby": sectionId,
    className: classNames(styles36.SectionGroup, !divider && styles36.noDivider)
  }, children2)));
}
...
function useSection() {
  const context = (0, import_react526.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react527.default.createElement("div", {
    className: styles37.Header
  }, children2) : children2;
...
var MappedActionContext = (0, import_react528.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react529.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const isAction = (0, import_react529.useContext)(ActionContext);
  const {
    role,
    url,
    external,
    onAction,
    destructive
  } = (0, import_react529.useContext)(MappedActionContext);
  const listItemRef = (0, import_react529.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionSelect = (0, import_react529.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    onAction && onAction();
  ...
  const content = typeof children2 === "string" ? import_react529.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react529.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react529.default.createElement("li", Object.assign({}, sectionAttributes, {
...
function Action(props) {
  ...
  const iconMarkup = icon && import_react530.default.createElement("div", {
    className: styles38.Icon
  }, import_react530.default.createElement(Icon, {
    color: "subdued",
    source: icon
  }));
  const className = classNames(styles38.Action, divider && styles38.ActionDivider);
  return import_react530.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react530.default.createElement(Option, props, import_react530.default.createElement("div", {
    className
  }, import_react530.default.createElement(TextOption, {
    selected,
    disabled
...
function Listbox({
  ...
  const [loading, setLoading] = (0, import_react531.useState)();
  const [activeOption, setActiveOption] = (0, import_react531.useState)();
  const [lazyLoading, setLazyLoading] = (0, import_react531.useState)(false);
  const [currentOptions, setCurrentOptions] = (0, import_react531.useState)([]);
  const {
  ...
  const scrollableRef = (0, import_react531.useRef)(null);
  const listboxRef = (0, import_react531.useRef)(null);
  const {
    listboxId,
    textFieldLabelId,
    textFieldFocused,
  ...
  (0, import_react531.useEffect)(() => {
    if (setListboxId && !listboxId) {
      setListboxId(listId);
    }
  }, [setListboxId, listboxId, listId]);
  const getNavigableOptions = (0, import_react531.useCallback)(() => {
    if (!listboxRef.current) {
      return [];
    }
    return [...new Set(listboxRef.current.querySelectorAll(OPTION_SELECTOR))];
  }, []);
  const getFirstNavigableOption = (0, import_react531.useCallback)((currentOptions2) => {
  ...
  const handleScrollIntoView = (0, import_react531.useCallback)((option) => {
    const {
      current: scrollable2
    } = scrollableRef;
    if (scrollable2) {
  ...
  const handleKeyToBottom = (0, import_react531.useCallback)(() => {
    if (onKeyToBottom) {
      setLazyLoading(true);
      return Promise.resolve(onKeyToBottom());
    }
  }, [onKeyToBottom]);
  const handleChangeActiveOption = (0, import_react531.useCallback)((nextOption) => {
    if (!nextOption)
  ...
  const getFormattedOption = (0, import_react531.useCallback)((element, index) => {
    return {
      element,
      index,
      domId: element.id,
  ...
  const resetActiveOption = (0, import_react531.useCallback)(() => {
  ...
  (0, import_react531.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children2 && import_react531.Children.count(children2) > 0) {
      resetActiveOption();
    }
  ...
  const onOptionSelect = (0, import_react531.useCallback)((option) => {
  ...
  const getNextIndex = (0, import_react531.useCallback)((currentIndex, lastIndex, direction) => {
    let nextIndex;
    if (direction === "down") {
  ...
  const getNextValidOption = (0, import_react531.useCallback)(async (key) => {
  ...
  const handleArrow = (0, import_react531.useCallback)(async (type, event) => {
    event.preventDefault();
    const {
      element,
      nextIndex
  ...
  const handleDownArrow = (0, import_react531.useCallback)((event) => {
    handleArrow("down", event);
  }, [handleArrow]);
  const handleUpArrow = (0, import_react531.useCallback)((event) => {
    handleArrow("up", event);
  }, [handleArrow]);
  const handleEnter = (0, import_react531.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    if (activeOption) {
  ...
  const handleFocus = (0, import_react531.useCallback)(() => {
    if (enableKeyboardControl)
      return;
    enableKeyboardEvents();
  }, [enableKeyboardControl, enableKeyboardEvents]);
  const handleBlur = (0, import_react531.useCallback)((event) => {
    event.stopPropagation();
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react531.default.createElement(import_react531.default.Fragment, null, import_react531.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react531.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  const listboxContext = (0, import_react531.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  return import_react531.default.createElement(import_react531.default.Fragment, null, listeners, import_react531.default.createElement(VisuallyHidden, null, import_react531.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react531.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react531.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react531.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
    className: styles30.Listbox,
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react532.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaClassNames = classNames(styles29.Media, disabled && styles29.disabledMedia, singleSelection && styles29.singleSelectionMedia);
  const mediaMarkup = media ? import_react532.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react532.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react532.default.createElement(Listbox.TextOption, {
    selected,
    disabled
  }, import_react532.default.createElement("div", {
...
var Spinner2 = import_react533.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp
  ...
  return import_react533.default.createElement("div", {
    className: styles41.Spinner,
    onClick,
    "aria-hidden": true,
    ref
  }, import_react533.default.createElement("div", {
    role: "button",
    className: styles41.Segment,
    tabIndex: -1,
    onClick: handleStep(1),
    onMouseDown: handleMouseDown(handleStep(1)),
    onMouseUp
  }, import_react533.default.createElement("div", {
    className: styles41.SpinnerIcon
  }, import_react533.default.createElement(Icon, {
...
function Label({
  ...
  const className = classNames(styles43.Label, hidden && styles43.hidden);
  return import_react534.default.createElement("div", {
    className
  }, import_react534.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
    className: classNames(styles43.Text, requiredIndicator && styles43.RequiredIndicator)
  }, children2));
}
...
function Labelled({
  ...
  const className = classNames(labelHidden && styles42.hidden);
  const actionMarkup = action ? import_react535.default.createElement("div", {
    className: styles42.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? import_react535.default.createElement("div", {
    className: styles42.HelpText,
    id: helpTextID2(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react535.default.createElement("div", {
    className: styles42.Error
  }, import_react535.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react535.default.createElement("div", {
    className: styles42.LabelWrapper
  }, import_react535.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Item4({
  ...
  const className = classNames(styles44.Item, focused && styles44["Item-focused"], position === "primary" ? styles44["Item-primary"] : styles44["Item-connection"]);
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react537.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react537.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react537.default.createElement("div", {
    className: styles44.Connected
  }, leftConnectionMarkup, import_react537.default.createElement(Item4, {
    position: "primary"
...
function Resizer({
  ...
  const contentNode = (0, import_react538.useRef)(null);
  const minimumLinesNode = (0, import_react538.useRef)(null);
  const animationFrame = (0, import_react538.useRef)();
  const currentHeight = (0, import_react538.useRef)(currentHeightProp);
  if (currentHeightProp !== currentHeight.current) {
    currentHeight.current = currentHeightProp;
  }
  (0, import_react538.useEffect)(() => {
    return () => {
  ...
  const minimumLinesMarkup = minimumLines ? import_react538.default.createElement("div", {
    ref: minimumLinesNode,
    className: styles41.DummyInput,
    dangerouslySetInnerHTML: {
      __html: getContentsForMinimumLines(minimumLines)
    }
  }) : null;
  const handleHeightCheck = (0, import_react538.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  (0, import_react538.useLayoutEffect)(() => {
    handleHeightCheck();
  });
  return import_react538.default.createElement("div", {
    "aria-hidden": true,
    className: styles41.Resizer
  }, import_react538.default.createElement(EventListener, {
    event: "resize",
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react539.useState)(null);
  const [focus, setFocus] = (0, import_react539.useState)(Boolean(focused));
  const isAfterInitial = useIsAfterInitialMount();
  const id = useUniqueId("TextField", idProp);
  const inputRef = (0, import_react539.useRef)(null);
  const textAreaRef = (0, import_react539.useRef)(null);
  const prefixRef = (0, import_react539.useRef)(null);
  const suffixRef = (0, import_react539.useRef)(null);
  const verticalContentRef = (0, import_react539.useRef)(null);
  const buttonPressTimer = (0, import_react539.useRef)();
  const spinnerRef = (0, import_react539.useRef)(null);
  (0, import_react539.useEffect)(() => {
  ...
  const className = classNames(styles41.TextField, Boolean(normalizedValue) && styles41.hasValue, disabled && styles41.disabled, readOnly && styles41.readOnly, error && styles41.error, multiline && styles41.multiline, focus && styles41.focus);
  const inputType = type === "currency" ? "text" : type;
  const prefixMarkup = prefix ? import_react539.default.createElement("div", {
    className: styles41.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react539.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    const characterCountClassName = classNames(styles41.CharacterCount, multiline && styles41.AlignFieldBottom);
    const characterCountText = !maxLength ? characterCount : `${characterCount}/${maxLength}`;
    characterCountMarkup = import_react539.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? import_react539.default.createElement("button", {
    type: "button",
    className: styles41.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, import_react539.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react539.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react539.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const handleButtonRelease = (0, import_react539.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react539.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react539.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react539.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? import_react539.default.createElement(Resizer, {
  ...
  const inputClassName = classNames(styles41.Input, align && styles41[variationName("Input-align", align)], suffix && styles41["Input-suffixed"], clearButton && styles41["Input-hasClearButton"], monospaced && styles41.monospaced, suggestion && styles41.suggestion);
  ...
  const input = (0, import_react539.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? import_react539.default.createElement("div", {
    className: styles41.VerticalContent,
    id: `${id}-VerticalContent`,
    ref: verticalContentRef,
    onClick: handleClickChild
  }, verticalContent, input) : null;
  const inputMarkup = verticalContent ? inputWithVerticalContentMarkup : input;
  const backdropMarkup = import_react539.default.createElement("div", {
    className: classNames(styles41.Backdrop, connectedLeft && styles41["Backdrop-connectedLeft"], connectedRight && styles41["Backdrop-connectedRight"])
  });
  return import_react539.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react539.default.createElement(Connected, {
    left: connectedLeft,
...
function TextField2({
  ...
  const textFieldId = (0, import_react540.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react540.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react540.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react540.useCallback)((event) => {
    if (onFocus)
      onFocus(event);
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react540.useCallback)((event) => {
    if (onBlur)
      onBlur(event);
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react540.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  return import_react540.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    type,
    ariaAutocomplete,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react541.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react541.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react541.useState)();
  const [listboxId, setListboxId] = (0, import_react541.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react541.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react541.Children.count(children2) > 0);
  const ref = (0, import_react541.useRef)(null);
  const handleClose = (0, import_react541.useCallback)(() => {
    setPopoverActive(false);
    onClose === null || onClose === void 0 ? void 0 : onClose();
    setActiveOptionId(void 0);
  }, [onClose]);
  const handleOpen = (0, import_react541.useCallback)(() => {
    setPopoverActive(true);
    setActiveOptionId(void 0);
  }, []);
  const onOptionSelected = (0, import_react541.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
      handleClose();
      setActiveOptionId(void 0);
  ...
  const handleFocus = (0, import_react541.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleChange = (0, import_react541.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleBlur = (0, import_react541.useCallback)(() => {
    if (popoverActive) {
      handleClose();
    }
  }, [popoverActive, handleClose]);
  const textFieldContextValue = (0, import_react541.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react541.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react541.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
    textFieldFocused,
    willLoadMoreOptions,
  ...
  return import_react541.default.createElement(Popover2, {
    ref,
    active: popoverActive,
    activator: import_react541.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react541.Children.count(children2) > 0 ? import_react541.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, import_react541.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react541.default.createElement(ComboboxListboxOptionContext.Provider, {
...
function MappedAction({
  ...
  const i18n = useI18n();
  let prefixMarkup = null;
  const contentOverflowStyle = wrapOverflow ? styles45.ContentWrap : void 0;
  if (prefix) {
    prefixMarkup = import_react542.default.createElement("div", {
      className: styles45.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react542.default.createElement("div", {
      className: styles45.Prefix
    }, import_react542.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react542.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react542.default.createElement("span", {
    className: styles45.Suffix
  }, import_react542.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react542.default.createElement("span", {
    className: styles45.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react542.default.createElement("div", {
    className: styles45.Text
  }, import_react542.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react542.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  const context = (0, import_react542.useMemo)(() => ({
    role,
    url,
    external,
    onAction,
  ...
  const actionClassNames = classNames(styles45.Action, disabled && styles45.disabled, destructive && styles45.destructive, active && styles45.selected);
  return import_react542.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react542.default.createElement("div", {
    className: styles45.ActionContainer
  }, import_react542.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react542.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react543.useCallback)((options2) => {
    return options2.map((option) => import_react543.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react543.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react543.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react543.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
      return import_react543.default.createElement("div", {
        className: styles28.SectionWrapper
      }, optionsMarkup2);
    }
    ...
    if (listTitle) {
      return import_react543.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react543.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react543.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react543.useCallback)((newSelection) => {
  ...
  const actionMarkup = actionBefore && import_react543.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react543.default.createElement("div", {
    role: "status"
  }, emptyState);
  const autoSelection = actionBefore ? AutoSelection.First : void 0;
  return import_react543.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition,
    willLoadMoreOptions: willLoadMoreResults
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react543.default.createElement(Listbox, {
    autoSelection,
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react544.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  const className = classNames(styles46.Backdrop, belowNavigation && styles46.belowNavigation, transparent && styles46.transparent);
  return import_react546.default.createElement(import_react546.default.Fragment, null, import_react546.default.createElement(ScrollLock, null), import_react546.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var BannerContext = (0, import_react547.createContext)(false);
...
function unstyledButtonFrom({
  ...
  return import_react548.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react549.forwardRef)(function Banner2({
  icon,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react549.useContext)(WithinContentContext);
  ...
  const className = classNames(styles47.Banner, status && styles47[variationName("status", status)], onDismiss && styles47.hasDismiss, shouldShowFocus && styles47.keyFocused, withinContentContainer ? styles47.withinContentContainer : styles47.withinPage);
  let headingMarkup = null;
  let headingID;
  if (title) {
    headingID = `${id}Heading`;
    headingMarkup = import_react549.default.createElement("div", {
      className: styles47.Heading,
      id: headingID
    }, import_react549.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react549.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
    className: classNames(styles47.Button, styles47.loading)
  }, import_react549.default.createElement("span", {
    className: styles47.Spinner
  }, import_react549.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react549.default.createElement("div", {
    className: styles47.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles47.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react549.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react549.default.createElement("div", {
    className: styles47.Actions
  }, import_react549.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react549.default.createElement("div", {
      className: styles47.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react549.default.createElement("div", {
    className: styles47.Dismiss
  }, import_react549.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
    accessibilityLabel: "Dismiss notification"
  }));
  return import_react549.default.createElement(BannerContext.Provider, {
    value: true
  }, import_react549.default.createElement("div", {
    className,
    tabIndex: 0,
    ref: wrapperRef,
    role: ariaRoleType,
  ...
  }, dismissButton, import_react549.default.createElement("div", {
    className: styles47.Ribbon
  }, import_react549.default.createElement(Icon, {
    source: iconName,
    color: iconColor
  })), import_react549.default.createElement("div", {
    className: styles47.ContentWrapper
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react549.default.createElement(UnstyledLink, {
      className: styles47.SecondaryAction,
      url: action.url,
      external: action.external
    }, import_react549.default.createElement("span", {
      className: styles47.Text
    }, action.content));
  }
  return import_react549.default.createElement(UnstyledButton, {
    className: styles47.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  const wrapperRef = (0, import_react549.useRef)(null);
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react549.useState)(false);
  (0, import_react549.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
var Bleed = ({
  ...
  return import_react550.default.createElement("div", {
    className: styles48.Bleed,
    style: sanitizeCustomProperties(style)
  }, children2);
};
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react551.default.createElement(import_react551.default.Fragment, null, import_react551.default.createElement("span", {
    className: styles49.Icon
  }, import_react551.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react551.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react551.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles49.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react551.default.createElement("button", {
    key: content,
    className: styles49.Breadcrumb,
  ...
  return import_react551.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}
...
var TransitionGroupContext_default = import_react552.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react553.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react553.default.cloneElement(import_react553.default.Children.only(children2), childProps));
  };
  return Transition2;
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react554.default.createElement(Transition_default, _extends({}, props, {
...
}(import_react554.default.Component);
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react555.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react555.Children.map(children2, function(c) {
      return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function(child) {
    return (0, import_react555.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react555.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react555.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react555.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react555.isValidElement)(prevChild)) {
      children2[key] = (0, import_react555.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component9 === null) {
      return import_react556.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react556.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react556.default.createElement(Component9, props, children2));
  };
  return TransitionGroup2;
}(import_react556.default.Component);
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react557.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react557.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react557.default.createElement(TransitionGroup_default, props, inProp ? import_react557.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react557.default.cloneElement(second, {
      key: "second",
...
}(import_react557.default.Component);
ReplaceTransition.propTypes = true ? {
  in: import_prop_types5.default.bool.isRequired,
  children: function children(props, propName) {
    if (import_react557.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react558.default.isValidElement(oldChildren) && import_react558.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react558.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react558.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react558.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react558.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react558.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react558.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react558.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
}(import_react558.default.Component);
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react559.useRef)(false);
...
function Indicator({
  ...
  const className = classNames(styles51.Indicator, pulse && styles51.pulseIndicator);
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react561.useRef)(null);
  ...
  return import_react561.default.createElement("div", {
    className: styles50.BulkActionButton,
    ref: bulkActionButton
  }, import_react561.default.createElement(Button, {
    external,
    url,
    "aria-label": accessibilityLabel,
    onClick: onAction,
    disabled,
    disclosure
  }, content), indicator && import_react561.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return import_react562.default.createElement(import_react562.default.Fragment, null, import_react562.default.createElement(Popover2, {
    active: isVisible,
    activator: import_react562.default.createElement(BulkActionButton, {
      disclosure: true,
...
var ResourceListContext = (0, import_react563.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react564.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react564.useContext)(ResourceListContext);
  ...
  const className = plain ? classNames(styles52.CheckableButton, styles52["CheckableButton-plain"]) : classNames(styles52.CheckableButton, selectMode && styles52["CheckableButton-selectMode"], selected && styles52["CheckableButton-selected"], measuring && styles52["CheckableButton-measuring"]);
  return import_react564.default.createElement("div", {
    className,
    onClick: onToggleAll
  }, import_react564.default.createElement("div", {
    className: styles52.Checkbox
  }, import_react564.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
...
var slideClasses = {
  appear: classNames(styles50.Slide, styles50["Slide-appear"]),
  appearActive: classNames(styles50.Slide, styles50["Slide-appearing"]),
  enter: classNames(styles50.Slide, styles50["Slide-enter"]),
  enterActive: classNames(styles50.Slide, styles50["Slide-entering"]),
  exit: classNames(styles50.Slide, styles50["Slide-exit"])
};
var BulkActionsInner = class extends import_react565.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react565.createRef)();
    this.largeScreenGroupNode = (0, import_react565.createRef)();
    this.smallScreenGroupNode = (0, import_react565.createRef)();
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react565.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react565.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react565.default.createElement("div", {
      className: styles50.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react565.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react565.default.createElement("div", {
      className: styles50.Popover,
      ref: this.setMoreActionsNode
    }, import_react565.default.createElement(Popover2, {
      active: smallScreenPopoverVisible,
      activator: import_react565.default.createElement(BulkActionButton, {
        disclosure: true,
    ...
    }, import_react565.default.createElement(ActionList, {
    ...
    const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => {
      if (instanceOfMenuGroupDescriptor(action)) {
        return import_react565.default.createElement(BulkActionMenu, Object.assign({
          key: index
        }, action, {
          isNewBadgeInBadgeActions: this.isNewBadgeInBadgeActions()
        }));
      }
      return import_react565.default.createElement(BulkActionButton, Object.assign({
        key: index,
        disabled
      }, action, {
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react565.default.createElement("div", {
      className: styles50.Popover,
      ref: this.setMoreActionsNode
    }, import_react565.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react565.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      nodeRef: this.smallScreenGroupNode
    }, (status) => {
      const smallScreenGroupClassName = classNames(styles50.Group, styles50["Group-smallScreen"], styles50[`Group-${status}`]);
      return import_react565.default.createElement("div", {
        ...
        className: styles50.ButtonGroupWrapper
      }, import_react565.default.createElement(ButtonGroup, {
        segmented: true
        ...
        className: styles50.CheckableContainer,
        ref: this.checkableWrapperNode
      }, import_react565.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react565.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react565.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react565.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react565.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      nodeRef: this.largeScreenGroupNode
    }, (status) => {
      const largeScreenGroupClassName = classNames(styles50.Group, styles50["Group-largeScreen"], !measuring && styles50[`Group-${status}`], measuring && styles50["Group-measuring"]);
      return import_react565.default.createElement("div", {
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react565.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function TextContainer({
  ...
  const className = classNames(styles54.TextContainer, spacing3 && styles54[variationName("spacing", spacing3)]);
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react567.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react567.default.createElement("div", {
    className: styles53.Dismiss
  ...
  const imageClassName = classNames(styles53.Image, onDismiss && styles53.DismissImage);
  const containerClassName = classNames(styles53.Container, onDismiss && styles53.hasDismiss);
  return import_react567.default.createElement(Card, null, import_react567.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react567.default.createElement(Card.Section, null, import_react567.default.createElement("div", {
    className: styles53.CalloutCard
  }, import_react567.default.createElement("div", {
    className: styles53.Content
  }, import_react567.default.createElement("div", {
    className: styles53.Title
  }, import_react567.default.createElement(Heading, null, title)), import_react567.default.createElement(TextContainer, null, children2), import_react567.default.createElement("div", {
    className: styles53.Buttons
  }, buttonMarkup)), import_react567.default.createElement(Image, {
    alt: "",
    className: imageClassName,
    source: illustration
  })))));
...
function Caption({
  ...
  return import_react568.default.createElement("p", {
    className: styles55.Caption
  }, children2);
}
...
function RadioButton({
  ...
  const inputNode = (0, import_react569.useRef)(null);
  const [keyFocused, setKeyFocused] = (0, import_react569.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
  const inputClassName = classNames(styles57.Input, keyFocused && styles57.keyFocused);
  const backdropClassName = classNames(styles57.Backdrop, mouseOver && styles57.hover);
  return import_react569.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
  ...
  }, import_react569.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const className = classNames(styles56.ChoiceList, titleHidden && styles56.titleHidden);
  const titleMarkup = title ? import_react570.default.createElement("legend", {
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react570.default.createElement("div", {
      className: styles56.ChoiceChildren
    }, renderedChildren) : null;
    return import_react570.default.createElement("li", {
      key: value,
      className: styles56.ChoiceItem
    }, import_react570.default.createElement(ControlComponent, {
      name: finalName,
      value,
      id,
      label,
  ...
  const errorMarkup = error && import_react570.default.createElement("div", {
    className: styles56.ChoiceError
  }, import_react570.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react570.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react570.default.createElement("ul", {
    className: styles56.Choices
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react571.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react571.useState)(open);
  const [animationState, setAnimationState] = (0, import_react571.useState)("idle");
  const collapsibleContainer = (0, import_react571.useRef)(null);
  const isFullyOpen = animationState === "idle" && open && isOpen;
  const isFullyClosed = animationState === "idle" && !open && !isOpen;
  const content = expandOnPrint || !isFullyClosed ? children2 : null;
  const wrapperClassName = classNames(styles58.Collapsible, isFullyClosed && styles58.isFullyClosed, expandOnPrint && styles58.expandOnPrint);
  ...
  const handleCompleteAnimation = (0, import_react571.useCallback)(({
    target
  }) => {
...
var Slidable = class extends import_react572.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react572.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react572.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react572.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react572.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react572.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    return import_react572.default.createElement("div", {
      ref: this.setNode,
      className: styles59.Slidable,
      onMouseDown: this.startDrag,
      onTouchStart: this.startDrag
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react572.default.createElement("div", {
      style: draggerPositioning,
      className: styles59.Dragger,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react573.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react573.default.createElement("div", {
      className: styles59.AlphaPicker,
      ref: this.setSliderHeight
    }, import_react573.default.createElement("div", {
      className: styles59.ColorLayer,
      style: {
        background
      }
    }), import_react573.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react574.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react574.default.createElement("div", {
      className: styles59.HuePicker,
      ref: this.setSliderHeight
    }, import_react574.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
      onChange: this.handleChange,
      onDraggerHeight: this.setDraggerHeight
...
var ColorPicker = class extends import_react575.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react575.default.createElement(AlphaPicker, {
      alpha,
      color,
      onChange: this.handleAlphaChange
    }) : null;
    const className = classNames(styles59.ColorPicker, fullWidth && styles59.fullWidth);
    return import_react575.default.createElement("div", {
      ...
      className: styles59.MainColor
    }, import_react575.default.createElement("div", {
      className: styles59.ColorLayer,
      style: {
        backgroundColor: colorString
      }
    }), import_react575.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react575.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react575.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
// node_modules/@shopify/polaris/build/esm/components/Columns/Columns.js
var import_react576 = __toESM(require_react());

// node_modules/@shopify/polaris/build/esm/components/Columns/Columns.scss.js
var styles60 = {
...
function Columns({
  ...
  const style = {
    "--pc-columns-xs": formatColumns(columns === null || columns === void 0 ? void 0 : columns.xs),
    ...
    "--pc-columns-space-xs": spacing3 !== null && spacing3 !== void 0 && spacing3.xs ? `var(--p-space-${spacing3 === null || spacing3 === void 0 ? void 0 : spacing3.xs})` : void 0,
    "--pc-columns-space-sm": spacing3 !== null && spacing3 !== void 0 && spacing3.sm ? `var(--p-space-${spacing3 === null || spacing3 === void 0 ? void 0 : spacing3.sm})` : void 0,
    "--pc-columns-space-md": spacing3 !== null && spacing3 !== void 0 && spacing3.md ? `var(--p-space-${spacing3 === null || spacing3 === void 0 ? void 0 : spacing3.md})` : void 0,
    "--pc-columns-space-lg": spacing3 !== null && spacing3 !== void 0 && spacing3.lg ? `var(--p-space-${spacing3 === null || spacing3 === void 0 ? void 0 : spacing3.lg})` : void 0,
    "--pc-columns-space-xl": spacing3 !== null && spacing3 !== void 0 && spacing3.xl ? `var(--p-space-${spacing3 === null || spacing3 === void 0 ? void 0 : spacing3.xl})` : void 0
  };
  return import_react576.default.createElement("div", {
    className: styles60.Columns,
    style: sanitizeCustomProperties(style)
  }, children2);
}
...
// node_modules/@shopify/polaris/build/esm/components/ContentBlock/ContentBlock.js
var import_react577 = __toESM(require_react());

// node_modules/@shopify/polaris/build/esm/components/ContentBlock/ContentBlock.scss.js
var styles61 = {
  "ContentBlock": "Polaris-ContentBlock",
  "md": "Polaris-ContentBlock--md",
  "lg": "Polaris-ContentBlock--lg"
};
...
var ContentBlock = ({
  ...
  const className = classNames(styles61.ContentBlock, styles61[width]);
...
var FrameContext = (0, import_react578.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react579.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react580.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
function Cell({
  ...
  const className = classNames(styles62.Cell, styles62[`Cell-${variationName("verticalAlign", verticalAlign)}`], firstColumn && styles62["Cell-firstColumn"], truncate && styles62["Cell-truncated"], header && styles62["Cell-header"], total && styles62["Cell-total"], totalInFooter && styles62["Cell-total-footer"], numeric && styles62["Cell-numeric"], sortable && styles62["Cell-sortable"], sorted && styles62["Cell-sorted"], stickyHeadingCell && styles62.StickyHeaderCell, hovered && styles62["Cell-hovered"], lastFixedFirstColumn && inFixedNthColumn && fixedCellVisible && styles62["Cell-separate"], nthColumn && inFixedNthColumn && stickyHeadingCell && styles62.FixedFirstColumn);
  const headerClassName = classNames(header && styles62.Heading, header && contentType === "text" && styles62["Heading-left"]);
  const iconClassName = classNames(sortable && styles62.Icon);
  ...
  const iconMarkup = import_react581.default.createElement("span", {
    className: iconClassName
  }, import_react581.default.createElement(Icon, {
    source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  const focusable = !(stickyHeadingCell && hasFixedNthColumn && nthColumn && !inFixedNthColumn);
  const sortableHeadingContent = import_react581.default.createElement("button", {
  ...
  const stickyHeading = import_react581.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? import_react581.default.createElement("th", Object.assign({}, headerCell.props, {
    "aria-sort": sortDirection
  }, colSpanProp, {
    ref: setRef,
    className,
  ...
  }), columnHeadingContent) : import_react581.default.createElement("th", Object.assign({}, colSpanProp, {
    ref: setRef,
    className,
    scope: "row",
    style: {
  ...
  }), truncate ? import_react581.default.createElement(TruncatedText, {
    className: styles62.TooltipContent
  }, content) : content);
  const cellMarkup = header || firstColumn || nthColumn ? headingMarkup : import_react581.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react581.useRef)(null);
  const {
    current
  } = textRef;
  const text = import_react581.default.createElement("span", {
    ref: textRef,
    className
  }, children2);
  return (current === null || current === void 0 ? void 0 : current.scrollWidth) > (current === null || current === void 0 ? void 0 : current.offsetWidth) ? import_react581.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return import_react582.default.createElement(import_react582.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react583.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react584.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return import_react584.default.createElement("div", null, import_react584.default.createElement("div", {
...
function Sticky(props) {
  ...
  return import_react584.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  const pipMarkup = columnVisibilityData.map((column, index) => {
    if (index < fixedFirstColumns)
      return;
    const className = classNames(styles62.Pip, column.isVisible && styles62["Pip-visible"]);
    return import_react585.default.createElement("div", {
      className,
      key: `pip-${index}`
    });
  });
  ...
  return import_react585.default.createElement("div", {
    className: styles62.Navigation,
    ref: setRef
  }, import_react585.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react585.default.createElement(Button, {
    plain: true,
...
var DataTableInner = class extends import_react586.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react586.createRef)();
    this.scrollContainer = (0, import_react586.createRef)();
    this.table = (0, import_react586.createRef)();
    this.stickyTable = (0, import_react586.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedNthColumn && inStickyHeader) {
        ...
        return [import_react586.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), import_react586.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = ({
      ...
      return import_react586.default.createElement(Cell, {
        total: true,
        totalInFooter,
    ...
    this.defaultRenderRow = ({
      ...
      const fixedFirstColumns = this.fixedFirstColumns();
      const className = classNames(styles62.TableRow, hoverable && styles62.hoverable);
      return import_react586.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const className = classNames(styles62.DataTable, condensed && styles62.condensed, totals && styles62.ShowTotals, showTotalsInFooter && styles62.ShowTotalsInFooter, hasZebraStripingOnData && styles62.ZebraStripingOnData, hasZebraStripingOnData && rowCountIsEven && styles62.RowCountIsEven);
    const wrapperClassName = classNames(styles62.TableWrapper, condensed && styles62.condensed, increasedTableDensity && styles62.IncreasedTableDensity, stickyHeader && styles62.StickyHeaderEnabled);
    const headingMarkup = import_react586.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedNthColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? import_react586.default.createElement("tr", null, totals.map((total, index) => this.renderTotals({
      total,
      index
    }))) : null;
    ...
    const fixedNthColumnMarkup = condensed && fixedFirstColumns !== 0 && import_react586.default.createElement("table", {
      className: classNames(styles62.FixedFirstColumn, !isScrolledFarthestLeft && styles62.separate),
      style: {
    ...
    }, import_react586.default.createElement("thead", null, import_react586.default.createElement("tr", {
      style: {
      ...
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && import_react586.default.createElement("tr", {
      style: {
      ...
      total,
      index
    })))), import_react586.default.createElement("tbody", null, nthColumns.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedNthColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && import_react586.default.createElement("tfoot", null, import_react586.default.createElement("tr", null, nthTotals === null || nthTotals === void 0 ? void 0 : nthTotals.map((total, index) => this.renderTotals({
      total,
      index
    })))));
    ...
    const footerMarkup = footerContent ? import_react586.default.createElement("div", {
      className: styles62.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react586.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : import_react586.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? import_react586.default.createElement(AfterInitialMount, null, import_react586.default.createElement("div", {
      className: styles62.StickyHeaderWrapper,
      role: "presentation"
    }, import_react586.default.createElement(Sticky, {
      ...
      const stickyHeaderInnerClassNames = classNames(styles62.StickyHeaderInner, isSticky && styles62["StickyHeaderInner-isSticky"]);
      const stickyHeaderTableClassNames = classNames(styles62.StickyHeaderTable, !isScrolledFarthestLeft && styles62.separate);
      return import_react586.default.createElement("div", {
        className: stickyHeaderInnerClassNames
      }, import_react586.default.createElement("div", null, navigationMarkup("sticky")), import_react586.default.createElement("table", {
        className: stickyHeaderTableClassNames,
        ref: this.stickyTable
      }, import_react586.default.createElement("thead", null, import_react586.default.createElement("tr", {
        className: styles62.StickyTableHeadingsRow
    ...
    return import_react586.default.createElement("div", {
      className: wrapperClassName,
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), import_react586.default.createElement("div", {
      className
    }, import_react586.default.createElement("div", {
      className: styles62.ScrollContainer,
    ...
    }), fixedNthColumnMarkup, import_react586.default.createElement("table", {
      className: styles62.Table,
      ref: this.table
    }, import_react586.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react586.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
  fixedFirstColumns() {
    const {
      hasFixedFirstColumn,
...
function DataTable(props) {
  const i18n = useI18n();
  return import_react586.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Weekday = (0, import_react587.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles63.Weekday, current && styles63["Weekday-current"]);
  return import_react587.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var Day = (0, import_react588.memo)(function Day2({
  day,
  focused,
  onClick,
  onHover = noop7,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react588.useRef)(null);
  ...
  if (!day) {
    return import_react588.default.createElement("td", {
      className: styles63.EmptyDayCell,
  ...
  const dayCellClassName = classNames(styles63.DayCell, selected && styles63["DayCell-selected"], (inRange || inHoveringRange) && !disabled && styles63["DayCell-inRange"], isLastSelectedDay && styles63["DayCell-lastInRange"], isFirstSelectedDay && styles63["DayCell-firstInRange"], isHoveringRight && styles63["DayCell-hoverRight"], rangeIsDifferent && styles63["DayCell-hasRange"]);
  const dayClassName = classNames(styles63.Day, selected && styles63["Day-selected"], disabled && styles63["Day-disabled"], today && styles63["Day-today"], (inRange || inHoveringRange) && !disabled && styles63["Day-inRange"], isLastSelectedDay && styles63["Day-lastInRange"], isFirstSelectedDay && styles63["Day-firstInRange"], isHoveringRight && styles63["Day-hoverRight"], rangeIsDifferent && styles63["Day-hasRange"]);
...
function Month({
  ...
  const className = classNames(styles63.Title, current && styles63["Month-current"]);
  const weeks = (0, import_react589.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react589.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react589.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react589.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react589.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react589.default.createElement("tr", {
    className: styles63.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react589.default.createElement("div", {
    className: styles63.MonthContainer
  }, import_react589.default.createElement("table", {
    role: "grid",
    className: styles63.Month
  }, import_react589.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react589.default.createElement("thead", null, import_react589.default.createElement("tr", {
    className: styles63.WeekHeadings
  }, weekdays)), import_react589.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react590.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react590.useState)(void 0);
  (0, import_react590.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react590.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react590.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react590.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react590.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react590.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  const handleKeyUp = (0, import_react590.useCallback)((event) => {
    const {
      key
    } = event;
  ...
  const monthIsSelected = (0, import_react590.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react590.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  const datePickerClassName = classNames(styles63.DatePicker);
  return import_react590.default.createElement("div", {
    ...
    className: styles63.Header
  }, import_react590.default.createElement(Button, {
    plain: true,
    ...
    className: styles63.MonthLayout
  }, import_react590.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react591.default.createElement("dt", {
    key: `dt${index}`,
    className: styles64.Term
  }, term), import_react591.default.createElement("dd", {
    key: `dd${index}`,
    className: styles64.Description
  }, description)], []);
  const className = classNames(styles64.DescriptionList, spacing3 === "tight" && styles64.spacingTight);
  return import_react591.default.createElement("dl", {
    className
  }, terms);
}
...
function DisplayText({
  ...
  const className = classNames(styles65.DisplayText, size && styles65[variationName("size", size)]);
  return import_react592.default.createElement(Element2, {
    className
  }, children2);
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react593.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react594.useContext)(DropZoneContext);
  ...
  const actionClassNames = classNames(styles67.Action, disabled && styles67.disabled);
  const actionMarkup = import_react594.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  const fileUploadClassName = classNames(styles67.FileUpload, measuring && styles67.measuring, size === "large" && styles67.large, size === "small" && styles67.small);
  const actionHintMarkup = actionHint && import_react594.default.createElement(Caption, null, import_react594.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react594.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react594.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
  ...
  return import_react594.default.createElement("div", {
...
var DropZone = function DropZone2({
  ...
  const node = (0, import_react595.useRef)(null);
  const dragTargets = (0, import_react595.useRef)([]);
  const adjustSize = (0, import_react595.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react595.useState)(false);
  const [internalError, setInternalError] = (0, import_react595.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react595.useState)("large");
  const [measuring, setMeasuring] = (0, import_react595.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react595.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react595.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react595.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react595.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react595.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  const classes = classNames(styles66.DropZone, outline && styles66.hasOutline, focused && styles66.focused, (active || dragging) && styles66.isDragging, disabled && styles66.isDisabled, (internalError || error) && styles66.hasError, !variableHeight && styles66[variationName("size", size)], measuring && styles66.measuring);
  ...
  const context = (0, import_react595.useMemo)(() => ({
    disabled,
    focused,
    size,
    type: type || "file",
  ...
  return import_react595.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react595.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, import_react595.default.createElement(VisuallyHidden, null, import_react595.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react595.default.createElement("div", {
  ...
  function overlayMarkup(icon, color, text) {
    return import_react595.default.createElement("div", {
      className: styles66.Overlay
    }, import_react595.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react595.default.createElement(Icon, {
      source: icon,
      color
    }), (size === "medium" || size === "large") && import_react595.default.createElement(Caption, null, import_react595.default.createElement(TextStyle, {
      variation: "strong"
    }, text))));
  }
  function open() {
...
var DropZoneInput = class extends import_react595.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react595.createRef)();
  ...
  render() {
    ...
    return import_react595.default.createElement("input", Object.assign({}, inputProps, {
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react596.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react596.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react596.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react596.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react596.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react597.useContext)(WithinContentContext);
  const className = classNames(styles68.EmptyState, fullWidth && styles68.fullWidth, imageContained && styles68.imageContained, withinContentContainer && styles68.withinContentContainer);
  const imageMarkup = largeImage ? import_react597.default.createElement(Image, {
    alt: "",
    role: "presentation",
    className: styles68.Image,
    source: largeImage,
    sourceSet: [{
      source: image,
      descriptor: "568w"
  ...
  }) : import_react597.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles68.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react597.default.createElement("div", {
    className: styles68.FooterContent
  }, import_react597.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react597.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react597.default.createElement("div", {
    className: styles68.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react597.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react597.default.createElement("div", {
    className: styles68.Actions
  }, import_react597.default.createElement(Stack, {
    alignment: "center",
    distribution: "center",
    spacing: "tight"
  }, secondaryActionMarkup, primaryActionMarkup)) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react597.default.createElement("div", {
    className: styles68.DetailsContainer
  }, import_react597.default.createElement("div", {
    className: styles68.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react597.default.createElement("div", {
    className: styles68.DetailsContainer
  });
  return import_react597.default.createElement("div", {
    className
  }, import_react597.default.createElement("div", {
    className: styles68.Section
  }, detailsMarkup, import_react597.default.createElement("div", {
    className: styles68.ImageContainer
  }, imageMarkup)));
}
...
function Truncate({
  ...
  return import_react598.default.createElement("span", {
    className: styles70.Truncate
  }, children2);
}
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = classNames(styles69.Item, status && styles69[variationName("status", status)]);
    const iconMarkup = icon ? import_react599.default.createElement(Icon, {
      source: icon
    }) : import_react599.default.createElement("span", {
      className: styles69.Bullet
    });
    const titleMarkup = title && import_react599.default.createElement("span", {
      className: styles69.Title
    }, title);
    const descriptionMarkup = description && import_react599.default.createElement("span", {
      className: styles69.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react599.Fragment;
    return import_react599.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react599.default.createElement("span", {
      className: styles69.Icon
    }, iconMarkup), import_react599.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react599.default.createElement("ul", {
    className: styles69.ExceptionList
  }, items);
}
...
function Item5({
  ...
  const className = classNames(styles72.Item, focused && styles72["Item-focused"]);
...
var ConnectedFilterControl = class extends import_react601.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react601.createRef)();
    this.proxyButtonContainer = (0, import_react601.createRef)();
    this.moreFiltersButtonContainer = (0, import_react601.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const className = classNames(styles72.ConnectedFilterControl, rightPopoverableActions && styles72.right);
    ...
    const RightContainerClassName = classNames(styles72.RightContainer, !shouldRenderMoreFiltersButton && styles72.RightContainerWithoutMoreFilters, queryFieldHidden && styles72.queryFieldHidden);
    const rightMarkup = actionsToRender.length > 0 ? import_react601.default.createElement("div", {
      className: RightContainerClassName
    }, this.popoverFrom(actionsToRender)) : null;
    const moreFiltersButtonContainerClassname = classNames(styles72.MoreFiltersButtonContainer, actionsToRender.length === 0 && styles72.onlyButtonVisible);
    const rightActionMarkup = rightAction ? import_react601.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react601.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react601.default.createElement("div", {
      className: styles72.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react601.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react601.default.createElement("div", {
      className: styles72.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react601.default.createElement(import_react601.default.Fragment, null, proxyButtonMarkup, import_react601.default.createElement("div", {
      className: styles72.Wrapper
    }, import_react601.default.createElement("div", {
      className,
      ref: this.container
    }, children2 ? import_react601.default.createElement("div", {
      className: styles72.CenterContainer
    }, import_react601.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react601.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react601.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react601.default.createElement(Item5, {
        key: action.key
      }, import_react601.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react602.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react602.default.createElement(import_react602.default.Fragment, null, children2);
}
...
function Tag({
  ...
  const className = classNames(styles73.Tag, disabled && styles73.disabled, onClick && styles73.clickable, onRemove && styles73.removable, url && !disabled && styles73.linkable, segmented && styles73.segmented);
  if (onClick) {
    return import_react603.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react603.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    className: classNames(styles73.Button, segmented && styles73.segmented),
    onClick: onRemove,
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react603.default.createElement(Icon, {
    source: SvgCancelSmallMinor
  })) : null;
  const tagContent = url && !disabled ? import_react603.default.createElement("a", {
    className: classNames(styles73.Link, segmented && styles73.segmented),
    href: url
  }, import_react603.default.createElement("span", {
    title: tagTitle,
    className: styles73.LinkText
  }, children2)) : import_react603.default.createElement("span", {
    title: tagTitle,
    className: styles73.TagText
  }, children2);
  return import_react603.default.createElement("span", {
    className
...
function useMediaQuery() {
  const mediaQuery = (0, import_react604.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function useFocusManager({
  ...
  const focusManager = (0, import_react605.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react605.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
var Focus = (0, import_react606.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  ...
  return import_react606.default.createElement(import_react606.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react607.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react607.useState)(true);
  (0, import_react607.useEffect)(() => {
  ...
  return import_react607.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react607.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react607.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react607.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children2));
...
var BOTTOM_CLASS_NAMES = {
  enter: classNames(styles74.Bottom, styles74.enterBottom),
  enterActive: classNames(styles74.Bottom, styles74.enterBottomActive),
  exit: classNames(styles74.Bottom, styles74.exitBottom),
  exitActive: classNames(styles74.Bottom, styles74.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: classNames(styles74.Right, styles74.enterRight),
  enterActive: classNames(styles74.Right, styles74.enterRightActive),
  exit: classNames(styles74.Right, styles74.exitRight),
  exitActive: classNames(styles74.Right, styles74.exitRightActive)
};
function Sheet({
  children: children2,
  open,
  ...
  const container = (0, import_react608.useRef)(null);
  const activatorRef = (0, import_react608.useRef)(null);
  const handleClose = (0, import_react608.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react608.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react608.default.createElement(import_react608.default.Fragment, null, activatorMarkup, import_react608.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react608.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react608.default.createElement("div", Object.assign({
    className: styles74.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react608.default.createElement(TrapFocus, {
    trapping: open
  }, import_react608.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    tabIndex: -1,
    className: styles74.Sheet,
    "aria-label": accessibilityLabel
  }, children2)))), import_react608.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react608.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react609.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.moreFiltersButtonContainer = (0, import_react609.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react609.createRef)();
    this.focusNode = (0, import_react609.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react609.default.createElement(import_react609.default.Fragment, null, import_react609.default.createElement(ScrollLock, null), import_react609.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const className = classNames(styles71.FilterTriggerContainer, filterIsOpen && styles71.open, index === 0 && styles71.first, filters.length !== 1 && index === filters.length - 1 && styles71.last);
      const appliedFilterContent = this.getAppliedFilterContent(filter.key);
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react609.default.createElement("div", {
        className: styles71.AppliedFilterBadgeContainer
      }, import_react609.default.createElement(Badge, {
        size: "small",
        status: "new"
      }, appliedFilterContent)) : null;
      const collapsibleID = `${filter.key}Collapsible`;
      const buttonClassName = classNames(styles71.FilterTrigger);
      return import_react609.default.createElement("div", {
        key: filter.key,
        className
      }, import_react609.default.createElement("button", {
        ...
        className: styles71.FilterTriggerLabelContainer
      }, import_react609.default.createElement("h3", {
        className: styles71.FilterTriggerTitle
      }, import_react609.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react609.default.createElement("span", {
        className: styles71.FilterTriggerIcon
      }, import_react609.default.createElement(Icon, {
        source: icon,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react609.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react609.default.createElement("div", {
        className: styles71.FilterNodeContainer
      }, import_react609.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react609.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react609.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react609.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react609.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react609.default.createElement("span", {
        className: styles71.SearchIcon
      }, import_react609.default.createElement(Icon, {
    ...
    const filtersContainerHeaderClassname = classNames(styles71.FiltersContainerHeader);
    const filtersDesktopHeaderMarkup = import_react609.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react609.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react609.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react609.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react609.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterClassname = classNames(styles71.FiltersContainerFooter);
    const filtersDesktopFooterMarkup = import_react609.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react609.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react609.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react609.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react609.default.createElement("div", {
      className: styles71.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react609.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react609.default.createElement("div", {
      className: styles71.EmptyFooterState
    }, import_react609.default.createElement(TextStyle, {
      variation: "subdued"
    }, import_react609.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react609.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react609.default.createElement("div", {
      className: styles71.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react609.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersMobileContainerContentClassName = classNames(styles71.FiltersMobileContainerContent);
    const filtersDesktopContainerContentClassName = classNames(styles71.FiltersDesktopContainerContent);
    const filtersContainerMarkup = isNavigationCollapsed ? import_react609.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react609.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react609.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      ...
      className: styles71.FiltersContainer
    }, filtersDesktopHeaderMarkup, import_react609.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react609.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles71.HelpText
    }, import_react609.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react609.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react609.default.createElement("div", {
      className: styles71.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react609.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react609.default.createElement(Button, {
      plain: true,
...
function Filters(props) {
  ...
  return import_react609.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FooterHelp({
  ...
  return import_react610.default.createElement("div", {
    className: styles75.FooterHelp
  }, import_react610.default.createElement("div", {
    className: styles75.Text
  }, children2));
}
...
function Form({
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react611.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react611.default.createElement(VisuallyHidden, null, import_react611.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react611.default.createElement("form", {
    acceptCharset,
    action,
...
function Item6({
  ...
  return children2 ? import_react612.default.createElement("div", {
    className: styles76.Item
  }, children2) : null;
}
...
function Group({
  ...
  const className = classNames(condensed ? styles76.condensed : styles76.grouped);
  ...
  if (helpText) {
    ...
    helpTextElement = import_react613.default.createElement("div", {
      id: helpTextID3,
  ...
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react613.default.createElement("div", {
      id: titleID,
      className: styles76.Title
    }, title);
  }
  const itemsMarkup = import_react613.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
  return import_react613.default.createElement("div", {
    ...
    className: styles76.Items
  }, itemsMarkup), helpTextElement);
}

// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react614.memo)(function FormLayout2({
  children: children2
}) {
  return import_react614.default.createElement("div", {
    className: styles76.FormLayout
  }, import_react614.Children.map(children2, wrapChildren));
});
...
function useIsMountedRef() {
  const isMounted = (0, import_react615.useRef)(false);
  (0, import_react615.useEffect)(() => {
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react616.useState)(0);
  const [animating, setAnimating] = (0, import_react616.useState)(false);
  (0, import_react616.useEffect)(() => {
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react617.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react617.useRef)(false);
  const node = (0, import_react617.useRef)(null);
  (0, import_react617.useEffect)(() => {
  ...
  return import_react617.default.createElement("div", {
    className: wrapperClassName,
    ref: node,
...
function Dialog({
  ...
  const containerNode = (0, import_react618.useRef)(null);
  const classes = classNames(styles82.Modal, small && styles82.sizeSmall, large && styles82.sizeLarge, limitHeight && styles82.limitHeight, fullScreen && styles82.fullScreen);
  ...
  return import_react618.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    className: styles82.Container,
    "data-polaris-layer": true,
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react618.default.createElement(TrapFocus, null, import_react618.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    "aria-labelledby": labelledBy,
    tabIndex: -1,
    className: styles82.Dialog
  }, import_react618.default.createElement("div", {
    className: classes
  }, import_react618.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
var fadeUpClasses = {
  appear: classNames(styles82.animateFadeUp, styles82.entering),
  appearActive: classNames(styles82.animateFadeUp, styles82.entered),
  enter: classNames(styles82.animateFadeUp, styles82.entering),
  enterActive: classNames(styles82.animateFadeUp, styles82.entered),
  exit: classNames(styles82.animateFadeUp, styles82.exiting),
  exitActive: classNames(styles82.animateFadeUp, styles82.exited)
};
function FadeUp({
  children: children2,
  ...props
}) {
  return import_react618.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function CloseButton({
  ...
  const i18n = useI18n();
  return import_react619.default.createElement("button", {
    onClick,
    className: classNames(styles84.CloseButton, titleHidden && styles84.titleHidden),
    "aria-label": i18n.translate("Polaris.Common.close")
  }, import_react619.default.createElement(Icon, {
...
function Header3({
  ...
  return import_react620.default.createElement("div", {
    className: titleHidden || !children2 ? styles83.titleHidden : styles83.Header
  }, import_react620.default.createElement("div", {
    id,
    className: styles83.Title
  }, import_react620.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react620.default.createElement(CloseButton, {
    titleHidden,
    onClick: onClose
  }));
}
...
function Section5({
  ...
  const className = classNames(styles85.Section, flush && styles85.flush, subdued && styles85.subdued, titleHidden && styles85.titleHidden);
  return import_react621.default.createElement("section", {
    className
  }, children2);
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react622.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  return import_react622.default.createElement("div", {
    className: styles86.Footer
  }, import_react622.default.createElement("div", {
    className: styles86.FooterContent
  }, import_react622.default.createElement(Stack, {
    alignment: "center"
  }, import_react622.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react623.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react623.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react623.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react623.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react623.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react623.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? import_react623.default.createElement("div", {
      className: styles81.Spinner
    }, import_react623.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react623.default.createElement("div", {
      className: styles81.Body
    }, body) : import_react623.default.createElement(Scrollable, {
      shadow: true,
      className: styles81.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react623.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react623.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      fullScreen
    }, import_react623.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    }, title), import_react623.default.createElement("div", {
      className: styles81.BodyWrapper
    }, bodyMarkup), footerMarkup);
    backdrop = import_react623.default.createElement(Backdrop, {
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react623.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react623.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react623.default.createElement(Portal, {
    idPrefix: "modal"
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react624.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react625.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react625.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react625.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react625.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react625.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react625.default.createElement("div", {
    className: styles80.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react625.default.createElement("div", {
    className: styles80.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles80.Contents, fullWidth && styles80.fullWidth);
  return import_react625.default.createElement(import_react625.default.Fragment, null, import_react625.default.createElement("div", {
    className: styles80.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react625.default.createElement("div", {
    className: contentsClassName
  }, import_react625.default.createElement("h2", {
    className: styles80.Message
  }, message), import_react625.default.createElement("div", {
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react626.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react627.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react628.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const dismissMarkup = import_react629.default.createElement("button", {
    type: "button",
    className: styles88.CloseButton,
    onClick: onDismiss
  }, import_react629.default.createElement(Icon, {
    source: SvgMobileCancelMajor
  }));
  const actionMarkup = action ? import_react629.default.createElement("div", {
    className: styles88.Action
  }, import_react629.default.createElement(Button, {
    plain: true,
    monochrome: true,
    onClick: action.onAction
  }, action.content)) : null;
  const className = classNames(styles88.Toast, error && styles88.error);
  return import_react629.default.createElement("div", {
    className
  }, import_react629.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onDismiss
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react630.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react630.createRef)();
    toastNodes[index] = toastNode;
    return import_react630.default.createElement(CSSTransition_default, {
    ...
    }, import_react630.default.createElement("div", {
      ref: toastNode
    }, import_react630.default.createElement(Toast, toast)));
  });
  return import_react630.default.createElement(Portal, null, import_react630.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), import_react630.default.createElement("div", {
    className: styles87.ToastManager,
    "aria-live": "assertive"
  }, import_react630.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
  enter: classNames(styles87.ToastWrapper, styles87["ToastWrapper-enter"]),
  enterDone: classNames(styles87.ToastWrapper, styles87["ToastWrapper-enter-done"]),
  exit: classNames(styles87.ToastWrapper, styles87["ToastWrapper-exit"])
};
...
var FrameInner = class extends import_react631.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react631.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react631.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react631.default.createElement(CSSTransition_default, {
    ...
    }, import_react631.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react631.default.createElement("button", {
      type: "button",
      ...
      tabIndex
    }, import_react631.default.createElement(Icon, {
      source: SvgMobileCancelMajor
    }))))) : null;
    const loadingMarkup = loadingStack > 0 ? import_react631.default.createElement("div", {
      className: styles77.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react631.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react631.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles77.ContextualSaveBar,
      type: "fade"
    }, import_react631.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react631.default.createElement("div", Object.assign({
      className: styles77.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react631.default.createElement("div", {
    ...
    const skipMarkup = import_react631.default.createElement("div", {
      className: skipClassName
    }, import_react631.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const frameClassName = classNames(styles77.Frame, navigation && styles77.hasNav, topBar && styles77.hasTopBar);
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react631.default.createElement(Backdrop, {
    ...
    return import_react631.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react631.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react631.default.createElement("main", {
      className: styles77.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react631.default.createElement("div", {
      className: styles77.Content
    }, children2)), import_react631.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react631.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react631.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FullscreenBar({
  ...
  return import_react632.default.createElement("div", {
    className: styles89.FullscreenBar
  }, import_react632.default.createElement("button", {
    className: styles89.BackAction,
    onClick: onAction,
...
function Cell2({
  ...
  const className = classNames(styles91.Cell, (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.xs) && styles91[`Cell-${columnSpan.xs}-column-xs`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.sm) && styles91[`Cell-${columnSpan.sm}-column-sm`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.md) && styles91[`Cell-${columnSpan.md}-column-md`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.lg) && styles91[`Cell-${columnSpan.lg}-column-lg`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.xl) && styles91[`Cell-${columnSpan.xl}-column-xl`]);
  const style = {
    gridArea,
...
var IndexContext = (0, import_react635.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react635.createContext)(void 0);
var IndexRowContext = (0, import_react635.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react636.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react636.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react636.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react636.useRef)(null);
  const handleSelectionChange = (0, import_react636.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react637.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react637.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react637.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react637.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react637.default.createElement(IndexSelectionChangeContext.Provider, {
...
var Cell3 = (0, import_react638.memo)(function Cell4({
  children: children2,
  className,
  flush
}) {
  const cellClassName = classNames(className, styles92.TableCell, flush && styles92["TableCell-flush"]);
  return import_react638.default.createElement("td", {
...
var RowContext = (0, import_react639.createContext)({});
var RowHoveredContext = (0, import_react639.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react639.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react640.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    disabled,
    onInteraction
  } = (0, import_react640.useContext)(RowContext);
  const wrapperClassName = classNames(styles93.Wrapper, condensed ? styles93.condensed : styles93.expanded);
  const Wrapper = condensed ? import_react640.Fragment : CheckboxWrapper;
  return import_react640.default.createElement(Wrapper, null, import_react640.default.createElement("div", {
    className: styles93.TableCellContentContainer
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react640.useRef)(null);
  const handleResize = (0, import_react640.useCallback)(debounce(() => {
  ...
  const checkboxClassName = classNames(styles92.TableCell, styles92["TableCell-first"]);
  return import_react640.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react641.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react641.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react641.useMemo)(() => ({
    itemId: id,
    selected,
    position,
  ...
  const primaryLinkElement = (0, import_react641.useRef)(null);
  const isNavigating = (0, import_react641.useRef)(false);
  const tableRowRef = (0, import_react641.useRef)(null);
  const tableRowCallbackRef = (0, import_react641.useCallback)((node) => {
  ...
  const rowClassName = classNames(styles92.TableRow, selectable && condensed && styles92.condensedRow, selected && styles92["TableRow-selected"], subdued && styles92["TableRow-subdued"], hovered && styles92["TableRow-hovered"], disabled && styles92["TableRow-disabled"], status && styles92[variationName("status", status)], !selectable && !primaryLinkElement.current && styles92["TableRow-unclickable"]);
  let handleRowClick;
  ...
  const checkboxMarkup = selectable ? import_react641.default.createElement(Checkbox3, null) : null;
  return import_react641.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react641.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react641.default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  const [containerScroll, setContainerScroll] = (0, import_react642.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react642.useCallback)(debounce(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react642.default.createElement(ScrollContext.Provider, {
    value: containerScroll
  }, import_react642.default.createElement("div", {
    className: styles94.ScrollContainer,
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react643.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react643.useRef)([]);
  const scrollableContainerElement = (0, import_react643.useRef)(null);
  const tableElement = (0, import_react643.useRef)(null);
  const condensedListElement = (0, import_react643.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react643.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react643.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react643.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react643.useState)(false);
  const [smallScreen, setSmallScreen] = (0, import_react643.useState)(isBreakpointsXS());
  const tableHeadings = (0, import_react643.useRef)([]);
  const stickyTableHeadings = (0, import_react643.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react643.useRef)(null);
  const firstStickyHeaderElement = (0, import_react643.useRef)(null);
  const stickyHeaderElement = (0, import_react643.useRef)(null);
  const scrollBarElement = (0, import_react643.useRef)(null);
  const scrollContainerElement = (0, import_react643.useRef)(null);
  const scrollingWithBar = (0, import_react643.useRef)(false);
  const scrollingContainer = (0, import_react643.useRef)(false);
  const tableBodyRef = (0, import_react643.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react643.useCallback)(() => {
    setIsSmallScreenSelectable((value) => !value);
  }, []);
  const handleSelectAllItemsInStore = (0, import_react643.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react643.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react643.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react643.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react643.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react643.useState)(true);
  const handleCanScrollRight = (0, import_react643.useCallback)(debounce(() => {
  ...
  const handleIsSmallScreen = (0, import_react643.useCallback)(() => {
    setSmallScreen(smallScreen);
  }, [smallScreen]);
  const [canFitStickyColumn, setCanFitStickyColumn] = (0, import_react643.useState)(true);
  const handleCanFitStickyColumn = (0, import_react643.useCallback)(() => {
  ...
  const handleResize = (0, import_react643.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react643.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react643.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react643.default.createElement("div", {
    className: styles92.TableHeading,
    key: getHeadingKey(headings[0]),
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react643.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react643.default.createElement("div", {
    className: styles92.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react643.default.createElement("div", {
    className: styles92["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0], 0)), !selectable && import_react643.default.createElement("div", {
    className: styles92.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0], 0))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react643.useCallback)(() => {
  ...
  const loadingTransitionClassNames = {
    enter: styles92["LoadingContainer-enter"],
    enterActive: styles92["LoadingContainer-enter-active"],
    exit: styles92["LoadingContainer-exit"],
    exitActive: styles92["LoadingContainer-exit-active"]
  };
  const loadingMarkup = import_react643.default.createElement(CSSTransition_default, {
    in: loading,
    ...
    className: styles92.LoadingPanel
  }, import_react643.default.createElement("div", {
    className: styles92.LoadingPanelRow
  }, import_react643.default.createElement(Spinner, {
    size: "small"
  }), import_react643.default.createElement("span", {
    className: styles92.LoadingPanelText
  }, i18n.translate("Polaris.IndexTable.resourceLoadingAccessibilityLabel", {
    resourceNamePlural: resourceName.plural.toLocaleLowerCase()
  })))));
  const stickyTableClassNames = classNames(styles92.StickyTable, condensed && styles92["StickyTable-condensed"]);
  const shouldShowBulkActions = bulkActionsSelectable && selectedItemsCount || isSmallScreenSelectable;
  const stickyHeaderMarkup = import_react643.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react643.default.createElement(Sticky, {
    boundingElement: stickyWrapper
  }, (isSticky) => {
    const stickyHeaderClassNames = classNames(styles92.StickyTableHeader, isSticky && styles92["StickyTableHeader-isSticky"]);
    const bulkActionClassNames = classNames(styles92.BulkActionsWrapper, condensed && styles92["StickyTableHeader-condensed"], isSticky && styles92["StickyTableHeader-isSticky"]);
    const shouldShowActions = !condensed || selectedItemsCount;
    const promotedActions = shouldShowActions ? promotedBulkActions : [];
    const actions = shouldShowActions ? bulkActions : [];
    const bulkActionsMarkup = shouldShowBulkActions ? import_react643.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react643.default.createElement(BulkActions, {
      smallScreen,
    ...
    const stickyColumnHeaderClassNames = classNames(styles92.StickyTableColumnHeader, hasMoreLeftColumns && styles92["StickyTableColumnHeader-isScrolling"]);
    const selectButtonMarkup = import_react643.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react643.default.createElement("div", {
      className: classNames(styles92.HeaderWrapper, !selectable && styles92.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react643.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react643.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react643.default.createElement("div", {
      className: styles92.StickyTableHeadings,
      ref: stickyHeaderElement
    }, stickyHeadingsMarkup));
    const stickyContent = bulkActionsMarkup ? bulkActionsMarkup : headerMarkup;
    return stickyContent;
  }));
  const scrollBarWrapperClassNames = classNames(styles92.ScrollBarContainer, condensed && styles92.scrollBarContainerCondensed, hideScrollContainer && styles92.scrollBarContainerHidden);
  const scrollBarClassNames = classNames(tableElement.current && tableInitialized && styles92.ScrollBarContent);
  const scrollBarMarkup = itemCount > 0 ? import_react643.default.createElement(AfterInitialMount, {
    ...
    className: styles92.ScrollBar,
    ref: scrollBarElement
  }, import_react643.default.createElement("div", {
    className: scrollBarClassNames
  })))) : null;
  const isSortable = sortable === null || sortable === void 0 ? void 0 : sortable.some((value) => value);
  const tableClassNames = classNames(styles92.Table, hasMoreLeftColumns && styles92["Table-scrolling"], selectMode && styles92.disableTextSelection, selectMode && shouldShowBulkActions && styles92.selectMode, !selectable && styles92["Table-unselectable"], canFitStickyColumn && styles92["Table-sticky"], isSortable && styles92["Table-sortable"], canFitStickyColumn && lastColumnSticky && styles92["Table-sticky-last"], canFitStickyColumn && lastColumnSticky && canScrollRight && styles92["Table-sticky-scrolling"]);
  const emptyStateMarkup = emptyState ? emptyState : import_react643.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react643.default.createElement(import_react643.default.Fragment, null, import_react643.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react643.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react643.default.createElement(import_react643.default.Fragment, null, sharedMarkup, import_react643.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles92.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react643.default.createElement(import_react643.default.Fragment, null, sharedMarkup, import_react643.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react643.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react643.default.createElement("thead", null, import_react643.default.createElement("tr", {
    className: styles92.HeadingRow
  }, headingsMarkup)), import_react643.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react643.default.createElement("div", {
    className: styles92.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react643.default.createElement(import_react643.default.Fragment, null, import_react643.default.createElement("div", {
    className: styles92.IndexTable
  ...
  function renderHeading(heading, index) {
    ...
    const headingContentClassName = classNames(styles92.TableHeading, hasSortable && styles92["TableHeading-sortable"], isSecond && styles92["TableHeading-second"], isLast && !heading.hidden && styles92["TableHeading-last"], !selectable && styles92["TableHeading-unselectable"], heading.flush && styles92["TableHeading-flush"]);
    ...
    const headingContent = import_react643.default.createElement("th", {
    ...
    const checkboxClassName = classNames(styles92.TableHeading, hasSortable && styles92["TableHeading-sortable"], index === 0 && styles92["TableHeading-first"]);
    const checkboxContent = import_react643.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    return import_react643.default.createElement("div", {
      className: styles92.ColumnHeaderCheckboxWrapper
    }, import_react643.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading, index) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react643.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react643.default.createElement("span", null, heading.title), import_react643.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react643.default.createElement(VisuallyHidden, null, heading.title);
    } else {
    ...
    if (sortable !== null && sortable !== void 0 && sortable[index]) {
      ...
      let SourceComponent = defaultSortDirection === "ascending" ? SvgSortAscendingMajor : SvgSortDescendingMajor;
      ...
      const iconMarkup = import_react643.default.createElement("span", {
        className: classNames(styles92.TableHeadingSortIcon, isCurrentlySorted && styles92["TableHeadingSortIcon-visible"])
      }, import_react643.default.createElement(SourceComponent, {
        focusable: "false",
        "aria-hidden": "true",
        className: styles92.TableHeadingSortSvg
      }));
      const sortMarkup = import_react643.default.createElement(UnstyledButton, {
        onClick: () => handleSortHeadingClick(index, newDirection),
        className: styles92.TableHeadingSortButton
      ...
      return import_react643.default.createElement(Tooltip, {
  ...
  function renderStickyHeading(heading, index) {
    ...
    const stickyHeadingClassName = classNames(styles92.TableHeading, index === 0 && styles92["StickyTableHeading-second"], index === 0 && !selectable && styles92.unselectable);
    return import_react643.default.createElement("div", {
...
function IndexTable({
  ...
  return import_react643.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react643.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
IndexTable.Cell = Cell3;
IndexTable.Row = Row;

// node_modules/@shopify/polaris/build/esm/components/Inline/Inline.js
var import_react644 = __toESM(require_react());

// node_modules/@shopify/polaris/build/esm/components/Inline/Inline.scss.js
var styles95 = {
...
var Inline = function Inline2({
  ...
  const style = {
    ...
    "--pc-inline-align-y": alignY ? AlignY[alignY] : void 0,
    "--pc-inline-wrap": wrap ? "wrap" : "nowrap",
    "--pc-inline-spacing": `var(--p-space-${spacing3})`
  };
  const itemMarkup = elementChildren(children2).map((child, index) => {
...
var InlineCode = ({
  children: children2
}) => import_react645.default.createElement("code", {
...
function KeyboardKey({
  ...
  return import_react646.default.createElement("kbd", {
    className: styles97.KeyboardKey
  }, key);
}
...
function KonamiCode({
  ...
  const position = (0, import_react647.useRef)(0);
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? import_react648.default.createElement("p", null, description) : description;
  ...
  }, import_react648.default.createElement(TextContainer, null, import_react648.default.createElement(Heading, {
    id
  }, title), descriptionMarkup && import_react648.default.createElement("div", {
    className: styles98.AnnotationDescription
  }, descriptionMarkup))), import_react648.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react650.default.createElement(Section6, null, children2) : children2;
...
function Link({
  ...
  return import_react651.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    ...
    return url ? import_react651.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
...
function Item7({
  ...
  return import_react652.default.createElement("li", {
...
var List = function List2({
  ...
  const className = classNames(styles100.List, type && styles100[variationName("type", type)]);
  const ListElement = type === "bullet" ? "ul" : "ol";
  return import_react653.default.createElement(ListElement, {
    className
  }, children2);
};
List.Item = Item7;
...
var Loading3 = (0, import_react654.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
  (0, import_react654.useEffect)(() => {
    startLoading();
    return () => {
      stopLoading();
    };
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react655.default.createElement(Heading, null, title) : title;
    headerMarkup = import_react655.default.createElement("div", {
      className: styles101.Heading
    }, headerContent);
  }
  const popoverActivator = import_react655.default.createElement(Button, {
    icon: SvgHorizontalDotsMinor,
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react655.default.createElement("div", {
    className: styles101.Popover
  ...
  const primaryActionMarkup = primaryAction ? import_react655.default.createElement("div", {
    className: styles101.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react655.default.createElement("div", {
    className: styles101.SecondaryAction
  }, buttonFrom(secondaryAction, {
    plain: true
  })) : null;
  const actionClassName = classNames(styles101.ActionContainer, portrait && styles101.portrait);
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react655.default.createElement("div", {
    className: actionClassName
  }, import_react655.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  ...
  return import_react655.default.createElement(Card, null, import_react655.default.createElement("div", {
    className: mediaCardClassName
  }, import_react655.default.createElement("div", {
    className: mediaContainerClassName
  }, children2), import_react655.default.createElement("div", {
    className: infoContainerClassName
  }, import_react655.default.createElement(Card.Section, null, popoverActionsMarkup, import_react655.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, headerMarkup, import_react655.default.createElement("p", {
    className: styles101.Description
...
var NavigationContext = (0, import_react656.createContext)({
  location: ""
});
...
function Secondary({
  ...
  return import_react657.default.createElement(Collapsible, {
    id: id || uid,
    open: expanded,
    transition: {
      duration: "0ms",
  ...
  }, import_react657.default.createElement("ul", {
...
function Item8({
  ...
  const {
    location,
    onNavigationDismiss
  } = (0, import_react658.useContext)(NavigationContext);
  const [keyFocused, setKeyFocused] = (0, import_react658.useState)(false);
  ...
  const handleKeyUp = (0, import_react658.useCallback)((event) => {
    if (event.keyCode === Key.Tab) {
      !keyFocused && setKeyFocused(true);
    }
  }, [keyFocused]);
  const handleBlur = (0, import_react658.useCallback)(() => {
  ...
  const indicatorMarkup = hasNewChild ? import_react658.default.createElement("span", {
    className: styles102.Indicator
  }, import_react658.default.createElement(Indicator, {
    pulse: true
  })) : null;
  const iconMarkup = icon ? import_react658.default.createElement("div", {
    className: classNames(styles102.Icon, shouldResizeIcon && styles102["Icon-resized"])
  }, import_react658.default.createElement(Icon, {
    source: icon
  })) : null;
  let badgeMarkup = null;
  if (isNew) {
    badgeMarkup = import_react658.default.createElement(Badge, {
      status: "new",
      size: "small"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react658.default.createElement("div", {
    className: styles102.Badge
  }, badgeMarkup);
  const itemContentMarkup = import_react658.default.createElement(import_react658.default.Fragment, null, iconMarkup, import_react658.default.createElement("span", {
    className: styles102.Text
  }, label, indicatorMarkup), wrappedBadgeMarkup);
  if (url == null) {
    const className2 = classNames(styles102.Item, disabled && styles102["Item-disabled"], keyFocused && styles102.keyFocused, selectedOverride && styles102["Item-selected"]);
    return import_react658.default.createElement("li", {
      className: styles102.ListItem
    }, import_react658.default.createElement("button", {
      type: "button",
  ...
  const secondaryActionLinkMarkup = secondaryAction && import_react658.default.createElement(UnstyledLink, {
    external: true,
  ...
  const secondaryActionMarkup = secondaryAction && (secondaryAction.tooltip ? import_react658.default.createElement(Tooltip, secondaryAction.tooltip, secondaryActionLinkMarkup) : secondaryActionLinkMarkup);
  ...
  const itemClassName = classNames(styles102.Item, disabled && styles102["Item-disabled"], selected && canBeActive && styles102["Item-selected"], showExpanded && styles102.subNavigationActive, childIsActive && styles102["Item-child-active"], keyFocused && styles102.keyFocused);
  ...
  if (subNavigationItems.length > 0) {
    ...
    const SecondaryNavigationClassName = classNames(styles102.SecondaryNavigation, showExpanded && styles102.isExpanded, !icon && styles102["SecondaryNavigation-noIcon"]);
    secondaryNavigationMarkup = import_react658.default.createElement("div", {
      className: SecondaryNavigationClassName
    }, import_react658.default.createElement(Secondary, {
      ...
      return import_react658.default.createElement(Item8, Object.assign({
        key: label2
      }, rest, {
        label: label2,
  ...
  const className = classNames(styles102.ListItem, secondaryAction && styles102["ListItem-hasAction"]);
  return import_react658.default.createElement("li", {
    className
  }, import_react658.default.createElement("div", {
    className: styles102.ItemWrapper
  }, import_react658.default.createElement(UnstyledLink, Object.assign({
    url,
...
function Section7({
  ...
  const animationFrame = (0, import_react659.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery();
  const [expandedIndex, setExpandedIndex] = (0, import_react659.useState)();
  ...
  const buttonMarkup = action && import_react659.default.createElement("button", {
    type: "button",
    className: styles102.Action,
    "aria-label": action.accessibilityLabel,
    onClick: action.onClick
  }, import_react659.default.createElement(Icon, {
    source: action.icon
  }));
  const actionMarkup = action && (action.tooltip ? import_react659.default.createElement(Tooltip, action.tooltip, buttonMarkup) : buttonMarkup);
  const sectionHeadingMarkup = title && import_react659.default.createElement("li", {
    className: styles102.SectionHeading
  }, import_react659.default.createElement("span", {
    className: styles102.Text
  }, title), actionMarkup);
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react659.default.createElement(Item8, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleRollup = rollup && items.length > rollup.after && import_react659.default.createElement("div", {
    className: styles102.ListItem,
    key: "List Item"
  }, import_react659.default.createElement("button", {
    type: "button",
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react659.default.createElement("li", {
    className: styles102.RollupSection
  }, import_react659.default.createElement(Collapsible, {
    id: additionalItemsId,
    open: expanded
  }, import_react659.default.createElement("ul", {
    className: styles102.List
  }, additionalItems)), toggleRollup);
  return import_react659.default.createElement("ul", {
    className
...
var Navigation2 = function Navigation3({
  ...
  const width = getWidth(logo, 104);
  const logoMarkup = logo ? import_react660.default.createElement("div", {
    className: classNames(styles102.LogoContainer, logoSuffix && styles102.hasLogoSuffix)
  }, import_react660.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles102.LogoLink,
    style: {
      width
    }
  }, import_react660.default.createElement(Image, {
  ...
  const mediaMarkup = contextControl ? import_react660.default.createElement("div", {
    className: styles102.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react660.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react660.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react660.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react660.default.createElement("nav", {
    className: styles102.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mediaMarkup, import_react660.default.createElement(Scrollable, {
...
function Checkbox5({
  ...
  const id = useUniqueId("Checkbox", idProp);
  const [keyFocused, setKeyFocused] = (0, import_react661.useState)(false);
  const className = classNames(styles105.Checkbox, active && styles105.active);
  const handleBlur = () => {
    setKeyFocused(false);
  };
  const handleKeyUp = () => {
  ...
  const inputClassName = classNames(styles105.Input, keyFocused && styles105.keyFocused);
  return import_react661.default.createElement("div", {
    className
  }, import_react661.default.createElement("input", {
    id,
    name,
    value,
    type: "checkbox",
    ...
    onKeyUp: handleKeyUp,
    role
  }), import_react661.default.createElement("div", {
    className: styles105.Backdrop
  }), import_react661.default.createElement("div", {
    className: styles105.Icon
  }, import_react661.default.createElement(Icon, {
...
function Option3({
  ...
  const handleClick = (0, import_react662.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const mediaMarkup = media ? import_react662.default.createElement("div", {
    className: styles104.Media
  }, media) : null;
  const singleSelectClassName = classNames(styles104.SingleSelectOption, focused && styles104.focused, disabled && styles104.disabled, select && styles104.select, active && styles104.active, verticalAlign && styles104[variationName("verticalAlign", verticalAlign)]);
  const multiSelectClassName = classNames(styles104.Label, disabled && styles104.disabled, active && styles104.active, select && styles104.select, verticalAlign && styles104[variationName("verticalAlign", verticalAlign)]);
  const checkBoxRole = role === "option" ? "presentation" : void 0;
  const optionMarkup = allowMultiple ? import_react662.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react662.default.createElement("div", {
    className: styles104.Checkbox
  }, import_react662.default.createElement(Checkbox5, {
    id,
    value,
    checked: select,
    active,
    ...
    role: checkBoxRole
  })), mediaMarkup, label) : import_react662.default.createElement("button", {
    id,
    type: "button",
  ...
  const scrollMarkup = active ? import_react662.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react662.default.createElement("li", {
    key: id,
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react663.useState)(createNormalizedOptions(options, sections, title));
  ...
  const handleClick = (0, import_react663.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react663.default.createElement("p", {
    ...
    const optionsMarkup2 = options2 && options2.map((option, optionIndex) => {
      ...
      return import_react663.default.createElement(Option3, Object.assign({
        key: optionId
      }, option, {
        id: optionId,
    ...
    return import_react663.default.createElement("li", {
      key: title2 || `noTitle-${sectionIndex}`
    }, titleMarkup, import_react663.default.createElement("ul", {
      className: styles103.Options,
      id: `${id}-${sectionIndex}`,
      role
    }, optionsMarkup2));
  }) : null;
  return import_react663.default.createElement("ul", {
    className: styles103.OptionList,
    role
  }, optionsMarkup);
}
...
function isInterface(x) {
  return !(0, import_react664.isValidElement)(x) && x !== void 0;
}
...
function isReactElement(x) {
  return (0, import_react665.isValidElement)(x) && x !== void 0;
}
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = (0, import_react666.createRef)();
  ...
  const prev = import_react666.default.createElement(Button, {
    outline: true,
    icon: SvgChevronLeftMinor,
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? import_react666.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip
  }, prev) : prev;
  const next = import_react666.default.createElement(Button, {
    outline: true,
    icon: SvgChevronRightMinor,
  ...
  const constructedNext = nextTooltip && hasNext ? import_react666.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip
  }, next) : next;
  const previousHandler = onPrevious || noop11;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => import_react666.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop11;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => import_react666.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  const labelTextMarkup = hasNext && hasPrevious ? import_react666.default.createElement(TextStyle, null, label) : import_react666.default.createElement(TextStyle, {
    variation: "subdued"
  }, label);
  const labelMarkup = label ? import_react666.default.createElement("div", {
    "aria-live": "polite"
  }, labelTextMarkup) : null;
  return import_react666.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, import_react666.default.createElement(ButtonGroup, {
    segmented: !label
...
function Title({
  ...
  const className = classNames(styles108.Title, subtitle && styles108.TitleWithSubtitle);
  const titleMarkup = title ? import_react667.default.createElement("h1", {
    className
  }, title) : null;
  const titleMetadataMarkup = titleMetadata ? import_react667.default.createElement("div", {
    className: styles108.TitleMetadata
  }, titleMetadata) : null;
  const wrappedTitleMarkup = titleMetadata ? import_react667.default.createElement("div", {
    className: styles108.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  const subtitleMarkup = subtitle ? import_react667.default.createElement("div", {
    className: classNames(styles108.SubTitle, compactTitle && styles108.SubtitleCompact)
  }, import_react667.default.createElement("p", null, subtitle)) : null;
  return import_react667.default.createElement(import_react667.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Header4({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? import_react668.default.createElement("div", {
    className: styles107.BreadcrumbWrapper
  }, import_react668.default.createElement(Breadcrumbs, {
    breadcrumbs
  })) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react668.default.createElement("div", {
    className: styles107.PaginationWrapper
  }, import_react668.default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? import_react668.default.createElement("div", {
    className: styles107.AdditionalNavigationWrapper
  }, additionalNavigation) : null;
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? import_react668.default.createElement("div", {
    className: styles107.Navigation
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup) : null;
  const pageTitleMarkup = import_react668.default.createElement("div", {
    className: styles107.TitleWrapper
  }, import_react668.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? import_react668.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = import_react668.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = import_react668.default.createElement(import_react668.default.Fragment, null, secondaryActions);
  }
  const additionalMetadataMarkup = additionalMetadata ? import_react668.default.createElement("div", {
    className: styles107.AdditionalMetaData
  }, import_react668.default.createElement(TextStyle, {
    variation: "subdued"
  }, additionalMetadata)) : null;
  const headerClassNames = classNames(styles107.Header, isSingleRow && styles107.isSingleRow, titleHidden && styles107.titleHidden, navigationMarkup && styles107.hasNavigation, actionMenuMarkup && styles107.hasActionMenu, isNavigationCollapsed && styles107.mobileView, !breadcrumbs.length && styles107.noBreadcrumbs, title && title.length < LONG_TITLE && styles107.mediumTitle, title && title.length > LONG_TITLE && styles107.longTitle);
  const {
    slot1,
    slot2,
    slot3,
  ...
  return import_react668.default.createElement("div", {
    className: headerClassNames
  }, import_react668.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react668.default.createElement("div", {
    className: styles107.Row
  }, slot1, slot2, import_react668.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react668.default.createElement("div", {
    className: styles107.RightAlign
  }, import_react668.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children2) => import_react668.default.createElement("div", {
      className: styles107.Actions
    }, children2)
  }, slot3, slot4))))), import_react668.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, import_react668.default.createElement("div", {
    className: styles107.Row
  }, import_react668.default.createElement("div", {
    className: styles107.LeftAlign
  }, slot5), import_react668.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? import_react668.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  } else {
  ...
  return import_react668.default.createElement("div", {
    className: styles107.PrimaryActionWrapper
  }, actionMarkup);
}
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react668.default.createElement(import_react668.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const pageClassName = classNames(styles106.Page, fullWidth && styles106.fullWidth, narrowWidth && styles106.narrowWidth);
  ...
  const contentClassName = classNames(!hasHeaderContent && styles106.Content, divider && hasHeaderContent && styles106.divider);
  const headerMarkup = hasHeaderContent ? import_react669.default.createElement(Header4, rest) : null;
  return import_react669.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react669.default.createElement("div", {
...
function PageActions({
  ...
  if (isReactElement(primaryAction)) {
    primaryActionMarkup = import_react670.default.createElement(import_react670.default.Fragment, null, primaryAction);
  ...
  if (isInterface(secondaryActions) && secondaryActions.length > 0) {
    secondaryActionsMarkup = import_react670.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions));
  } else if (isReactElement(secondaryActions)) {
    secondaryActionsMarkup = import_react670.default.createElement(import_react670.default.Fragment, null, secondaryActions);
  }
  const distribution = secondaryActionsMarkup ? "equalSpacing" : "trailing";
  return import_react670.default.createElement("div", {
    className: styles109.PageActions
  }, import_react670.default.createElement(Stack, {
    distribution,
    spacing: "tight"
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react671.StrictMode : import_react671.Fragment;
  const intl = (0, import_react671.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react671.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react671.useMemo)(() => new StickyManager(), []);
  const uniqueIdFactory = (0, import_react671.useMemo)(() => new UniqueIdFactory(globalIdGeneratorFactory), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react671.default.createElement(Wrapper, null, import_react671.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react671.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react671.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react671.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react671.default.createElement(UniqueIdFactoryContext.Provider, {
    value: uniqueIdFactory
  }, import_react671.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react671.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react671.default.createElement(PortalsManager, null, import_react671.default.createElement(FocusManager, null, import_react671.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children2)))))))))));
}
function noop12() {
...
function ProgressBar({
  ...
  const i18n = useI18n();
  const className = classNames(styles110.ProgressBar, size && styles110[variationName("size", size)], color && styles110[variationName("color", color)]);
  ...
  return import_react672.default.createElement("div", {
    className
  }, import_react672.default.createElement("progress", {
    "aria-labelledby": ariaLabelledBy,
    className: styles110.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react672.default.createElement(CSSTransition_default, {
    in: true,
    appear: true,
  ...
  }, import_react672.default.createElement("span", {
...
var DualThumb = class extends import_react673.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = (0, import_react673.createRef)();
    this.trackWrapper = (0, import_react673.createRef)();
    this.thumbLower = (0, import_react673.createRef)();
    this.thumbUpper = (0, import_react673.createRef)();
  ...
  render() {
    ...
    const outputMarkupLower = !disabled && output ? import_react673.default.createElement("output", {
      htmlFor: idLower,
      className: outputLowerClassName,
      style: {
        left: `${leftPositionThumbLower}px`
      }
    }, import_react673.default.createElement("div", {
      className: styles111.OutputBubble
    }, import_react673.default.createElement("span", {
      className: styles111.OutputText
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles111.Output, styles111.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react673.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react673.default.createElement("div", {
      className: styles111.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react673.default.createElement("div", {
      className: styles111.Suffix
    }, suffix);
    return import_react673.default.createElement(import_react673.default.Fragment, null, import_react673.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
    ...
    }, prefixMarkup, import_react673.default.createElement("div", {
      ...
      className: styles111["Track--dashed"]
    }), import_react673.default.createElement("div", {
      id: idLower,
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react673.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react673.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react674.default.createElement("output", {
    htmlFor: id,
    className: styles112.Output
  }, import_react674.default.createElement("div", {
    className: styles112.OutputBubble
  }, import_react674.default.createElement("span", {
    className: styles112.OutputText
  }, clampedValue)));
  const prefixMarkup = prefix && import_react674.default.createElement("div", {
    className: styles112.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react674.default.createElement("div", {
  ...
  return import_react674.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react674.default.createElement("div", {
    className: styles112.InputWrapper
  }, import_react674.default.createElement("input", {
    type: "range",
...
function RangeSlider({
  ...
  return isDualThumb(value) ? import_react675.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react675.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
var BaseResourceItem = class extends import_react676.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = (0, import_react676.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    const mediaMarkup = media ? import_react676.default.createElement("div", {
      className: styles113.Media
    }, media) : null;
    if (selectable) {
      const checkboxAccessibilityLabel = name || accessibilityLabel || i18n.translate("Polaris.Common.checkbox");
      handleMarkup = import_react676.default.createElement("div", {
        className: styles113.Handle,
        onClick: this.handleLargerSelectionArea
      }, import_react676.default.createElement("div", {
        onClick: stopPropagation2,
        className: styles113.CheckboxWrapper
      }, import_react676.default.createElement("div", {
        onChange: this.handleLargerSelectionArea
      }, import_react676.default.createElement(Checkbox, {
        id: this.checkboxId,
    ...
    if (media || selectable) {
      ownedMarkup = import_react676.default.createElement("div", {
        className: classNames(styles113.Owned, !mediaMarkup && styles113.OwnedNoMedia)
      }, handleMarkup, mediaMarkup);
    }
    const className = classNames(styles113.ResourceItem, focused && styles113.focused, selectable && styles113.selectable, selected && styles113.selected, selectMode && styles113.selectMode, persistActions && styles113.persistActions, focusedInner && styles113.focusedInner);
    const listItemClassName = classNames(styles113.ListItem, focused && !focusedInner && styles113.focused);
    let actionsMarkup = null;
    let disclosureMarkup = null;
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = import_react676.default.createElement("div", {
          className: styles113.Actions,
          onClick: stopPropagation2
        }, import_react676.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = import_react676.default.createElement("div", {
          className: styles113.Disclosure,
          onClick: stopPropagation2
        }, import_react676.default.createElement(Popover2, {
          activator: import_react676.default.createElement(Button, {
        ...
        actionsMarkup = import_react676.default.createElement("div", {
          className: styles113.Actions,
          onClick: stopPropagation2
        }, import_react676.default.createElement(ButtonGroup, {
          segmented: true
    ...
    const content = children2 ? import_react676.default.createElement("div", {
      className: styles113.Content
    }, children2) : null;
    const containerClassName = classNames(styles113.Container, verticalAlignment && styles113[variationName("alignment", verticalAlignment)]);
    const containerMarkup = import_react676.default.createElement("div", {
      className: containerClassName,
      id: this.props.id
    ...
    const accessibleMarkup = url ? import_react676.default.createElement(UnstyledLink, {
    ...
    return import_react676.default.createElement("li", {
...
function ResourceItem(props) {
  return import_react676.default.createElement(BaseResourceItem, Object.assign({}, props, {
    context: (0, import_react676.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react677.useRef)(UNIQUE_IDENTIFIER);
...
function Select({
  ...
  const className = classNames(styles115.Select, error && styles115.error, disabled && styles115.disabled);
  ...
  const inlineLabelMarkup = labelInline && import_react678.default.createElement("span", {
    className: styles115.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const prefixMarkup = selectedOption.prefix && import_react678.default.createElement("div", {
    className: styles115.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react678.default.createElement("div", {
    className: styles115.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react678.default.createElement("span", {
    className: styles115.SelectedOption
  }, selectedOption.label), import_react678.default.createElement("span", {
    className: styles115.Icon
  }, import_react678.default.createElement(Icon, {
    source: SvgSelectMinor
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return import_react678.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className
  }, import_react678.default.createElement("select", {
    id,
    name,
    value,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react678.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return import_react678.default.createElement("option", Object.assign({
    key: value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react678.default.createElement("optgroup", {
      label: title,
      key: title
...
var ResourceList = function ResourceList2({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react679.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react679.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react679.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react679.useState)(isBreakpointsXS2());
  const forceUpdate = (0, import_react679.useReducer)((x = 0) => x + 1, 0)[1];
  const [checkableButtons, setCheckableButtons] = (0, import_react679.useState)(/* @__PURE__ */ new Map());
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react679.useRef)(null);
  ...
  const setLoadingPosition = (0, import_react679.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? import_react679.default.createElement("div", {
    className: styles114.BulkActionsWrapper
  }, import_react679.default.createElement(BulkActions, {
  ...
  const filterControlMarkup = filterControl ? import_react679.default.createElement("div", {
    className: styles114.FiltersWrapper
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react679.default.createElement("div", {
    className: styles114.SortWrapper
  }, import_react679.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react679.default.createElement("div", {
    className: styles114.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react679.default.createElement("div", {
    className: styles114.HeaderTitleWrapper
  }, headerTitle());
  const selectButtonMarkup = isSelectable ? import_react679.default.createElement("div", {
  ...
  const checkableButtonMarkup = isSelectable ? import_react679.default.createElement("div", {
    className: styles114.CheckableButtonWrapper
  }, import_react679.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  const headerWrapperOverlay = loading ? import_react679.default.createElement("div", {
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react679.default.createElement("div", {
    className: styles114.HeaderOuterWrapper
  }, import_react679.default.createElement(Sticky, {
    boundingElement: listRef.current
  }, (isSticky) => {
    const headerClassName = classNames(styles114.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles114["HeaderWrapper-hasSort"], alternateTool && styles114["HeaderWrapper-hasAlternateTool"], isSelectable && styles114["HeaderWrapper-hasSelect"], loading && styles114["HeaderWrapper-disabled"], isSelectable && selectMode && styles114["HeaderWrapper-inSelectMode"], isSticky && styles114["HeaderWrapper-isSticky"]);
    return import_react679.default.createElement("div", {
      className: headerClassName
    }, import_react679.default.createElement(EventListener, {
      event: "resize",
      handler: handleResize
    }), headerWrapperOverlay, import_react679.default.createElement("div", {
  ...
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react679.default.createElement("div", {
    className: styles114.EmptySearchResultWrapper
  }, import_react679.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react679.default.createElement(import_react679.default.Fragment, null, import_react679.default.createElement("li", {
    className: styles114.SpinnerContainer,
    style: spinnerStyle
  }, import_react679.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react679.default.createElement("li", {
  ...
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react679.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  ...
  const listMarkup = itemsExist ? import_react679.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react679.Children.toArray(items.map(renderItemWithId))) : null;
  const context = {
  ...
  return import_react679.default.createElement(ResourceListContext.Provider, {
    value: context
...
function SettingToggle({
  ...
  const id = (0, import_react680.useMemo)(getUniqueSettingToggleId, []);
  ...
  return import_react680.default.createElement(Card, {
    sectioned: true
  }, import_react680.default.createElement(SettingAction, {
    action: actionMarkup
  }, import_react680.default.createElement("label", {
    htmlFor: id
  }, children2)));
}
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react681.default.createElement("div", {
      className: styles116.SkeletonBodyText,
      key: i
    }));
  }
  return import_react681.default.createElement(import_react681.default.Fragment, null, bodyTextLines);
}
...
function SkeletonDisplayText({
  ...
  const className = classNames(styles117.DisplayText, size && styles117[variationName("size", size)]);
  return import_react682.default.createElement("div", {
    className
  });
}
...
function SkeletonPage({
  ...
  const i18n = useI18n();
  const className = classNames(styles118.Page, fullWidth && styles118.fullWidth, narrowWidth && styles118.narrowWidth);
  const titleContent = title ? import_react683.default.createElement("h1", {
    className: styles118.Title
  }, title) : import_react683.default.createElement("div", {
    className: styles118.SkeletonTitle
  });
  const titleMarkup = import_react683.default.createElement("div", {
    className: styles118.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? import_react683.default.createElement("div", {
    className: styles118.PrimaryAction
  }, import_react683.default.createElement(SkeletonDisplayText, {
    size: "large"
  })) : null;
  const breadcrumbMarkup = breadcrumbs ? import_react683.default.createElement("div", {
    className: styles118.BreadcrumbAction,
    style: {
      width: 60
    }
  }, import_react683.default.createElement(SkeletonBodyText, {
    lines: 1
  })) : null;
  return import_react683.default.createElement("div", {
    className,
    role: "status",
    "aria-label": i18n.translate("Polaris.SkeletonPage.loadingLabel")
  }, import_react683.default.createElement("div", {
    className: styles118.Header
  }, breadcrumbMarkup, import_react683.default.createElement("div", {
    className: styles118.TitleAndPrimaryAction
  }, titleMarkup, primaryActionMarkup)), import_react683.default.createElement("div", {
    className: styles118.Content
  }, children2));
}
...
function SkeletonTabs({
  ...
  return import_react684.default.createElement("div", {
    className: styles119.Tabs
  }, [...Array(count).keys()].map((key) => {
    const tabWidthClassName = key % 2 === 0 ? styles119["Tab-short"] : styles119["Tab-long"];
    return import_react684.default.createElement("div", {
      key,
      className: classNames(styles119.Tab, tabWidthClassName)
    }, import_react684.default.createElement(SkeletonBodyText, {
      lines: 1
    }));
  }));
}
...
function SkeletonThumbnail({
  ...
  const className = classNames(styles120.SkeletonThumbnail, size && styles120[variationName("size", size)]);
  return import_react685.default.createElement("div", {
    className
  });
}
...
function Panel({
  ...
  const className = classNames(styles121.Panel, hidden && styles121["Panel-hidden"]);
  return import_react686.default.createElement("div", {
    className,
    id,
    role: "tabpanel",
...
function Tab({
  ...
  const wasSelected = (0, import_react687.useRef)(selected);
  const panelFocused = (0, import_react687.useRef)(false);
  const node = (0, import_react687.useRef)(null);
  (0, import_react687.useEffect)(() => {
    if (measuring) {
      return;
    }
  ...
  const className = classNames(styles121.Tab, selected && styles121["Tab-selected"]);
  let tabIndex;
  ...
  const tabContainerClassNames = classNames(styles121.TabContainer, selected && styles121.Underline);
  const markup = url ? import_react687.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
    ...
    "aria-label": accessibilityLabel,
    onMouseUp: handleMouseUpByBlurring
  }, import_react687.default.createElement("span", {
    className: styles121.Title
  }, children2)) : import_react687.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
  ...
  return import_react687.default.createElement("li", {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer = (0, import_react688.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react688.useRef)(null);
  const animationFrame = (0, import_react688.useRef)(null);
  const handleMeasurement = (0, import_react688.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react688.default.createElement(Tab, {
      measuring: true,
  ...
  const classname = classNames(styles121.Tabs, styles121.TabMeasurer);
  return import_react688.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react688.default.createElement(EventListener, {
    event: "resize",
...
var Item9 = class extends import_react689.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  ...
  render() {
    ...
    const classname = classNames(styles121.Item);
    const sharedProps = {
      id,
    ...
    const markup = url ? import_react689.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children2) : import_react689.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children2);
    return import_react689.default.createElement("li", null, markup);
  }
};
...
function List3({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react690.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return import_react690.default.createElement("ul", {
    className: styles121.List,
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/Tabs.js
var TabsInner = class extends import_react691.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      return import_react691.default.createElement(Tab, {
        key: `${index}-${tab.id}`,
        id: tab.id,
    ...
    this.handleFocus = (event) => {
      ...
      const target = event.target;
      if (target.classList.contains(styles121.Tab) || target.classList.contains(styles121.Item)) {
        let tabToFocus = -1;
      ...
      if (target.classList.contains(styles121.DisclosureActivator)) {
        return;
      }
      ...
      if (relatedTarget instanceof HTMLElement && !relatedTarget.classList.contains(styles121.Tab) && !relatedTarget.classList.contains(styles121.Item) && !relatedTarget.classList.contains(styles121.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
    ...
    this.handleBlur = (event) => {
      ...
      if (target instanceof HTMLElement && !target.classList.contains(styles121.Tab) && !target.classList.contains(styles121.Item)) {
        this.setState({
          tabToFocus: -1
        });
      }
  ...
  render() {
    ...
    const panelMarkup = children2 ? tabs.map((_tab, index) => {
      return selected === index ? import_react691.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children2) : import_react691.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const classname = classNames(styles121.Tabs, fitted && styles121.fitted, disclosureActivatorVisible && styles121.fillSpace);
    const disclosureTabClassName = classNames(styles121.DisclosureTab, disclosureActivatorVisible && styles121["DisclosureTab-visible"]);
    const disclosureButtonClassName = classNames(styles121.DisclosureActivator, hasCustomDisclosure && styles121.Tab);
    const disclosureButtonContentWrapperClassName = classNames(styles121.Title, hasCustomDisclosure && styles121.titleWithIcon);
    const disclosureButtonContent = hasCustomDisclosure ? import_react691.default.createElement(import_react691.default.Fragment, null, disclosureText, import_react691.default.createElement(Icon, {
      source: SvgCaretDownMinor,
      color: "subdued"
    })) : import_react691.default.createElement(Icon, {
      source: SvgHorizontalDotsMinor,
      color: "subdued"
    });
    const disclosureButton = import_react691.default.createElement("button", {
      type: "button",
      className: disclosureButtonClassName,
      onClick: this.handleDisclosureActivatorClick,
      "aria-label": i18n.translate("Polaris.Tabs.toggleTabsLabel")
    }, import_react691.default.createElement("span", {
      className: disclosureButtonContentWrapperClassName
    }, disclosureButtonContent));
    const activator = disclosureText ? import_react691.default.createElement("div", {
      className: styles121.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react691.default.createElement("div", null, import_react691.default.createElement("div", {
      className: styles121.Wrapper
    }, import_react691.default.createElement(TabMeasurer, {
      tabToFocus,
      activator,
      selected,
      tabs,
      siblingTabHasFocus: tabToFocus > -1,
      handleMeasurement: this.handleMeasurement
    }), import_react691.default.createElement("ul", {
      role: "tablist",
      className: classname,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
    ...
    }, tabsMarkup, import_react691.default.createElement("li", {
      className: disclosureTabClassName,
      role: "presentation"
    }, import_react691.default.createElement(Popover2, {
      preferredPosition: "below",
      activator,
      active: disclosureActivatorVisible && showDisclosure,
      onClose: this.handleClose,
      autofocusTarget: "first-node"
    }, import_react691.default.createElement(List3, {
...
function Tabs(props) {
  const i18n = useI18n();
  return import_react691.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Text = ({
  ...
  const className = classNames(styles122.root, styles122[variant], fontWeight ? styles122[fontWeight] : styles122[VariantFontWeightMapping[variant]], (alignment || truncate) && styles122.block, alignment && styles122[alignment], color && styles122[color], truncate && styles122.truncate, visuallyHidden && styles122.visuallyHidden);
  return import_react692.default.createElement(Component9, {
    className
  }, children2);
};
...
function Thumbnail({
  ...
  const className = classNames(styles123.Thumbnail, size && styles123[variationName("size", size)], transparent && styles123.transparent);
  const content = typeof source === "string" ? import_react693.default.createElement(Image, {
    alt,
    source
  ...
  return import_react693.default.createElement("span", {
    className
  }, content);
}

// node_modules/@shopify/polaris/build/esm/components/Tiles/Tiles.js
var import_react694 = __toESM(require_react());

// node_modules/@shopify/polaris/build/esm/components/Tiles/Tiles.scss.js
var styles124 = {
  "Tiles": "Polaris-Tiles"
};
...
var Tiles = ({
  ...
  const style = {
    "--pc-tile-gap-xs": gap !== null && gap !== void 0 && gap.xs ? `var(--p-space-${gap === null || gap === void 0 ? void 0 : gap.xs})` : void 0,
    "--pc-tile-gap-sm": gap !== null && gap !== void 0 && gap.sm ? `var(--p-space-${gap === null || gap === void 0 ? void 0 : gap.sm})` : void 0,
    "--pc-tile-gap-md": gap !== null && gap !== void 0 && gap.md ? `var(--p-space-${gap === null || gap === void 0 ? void 0 : gap.md})` : void 0,
    "--pc-tile-gap-lg": gap !== null && gap !== void 0 && gap.lg ? `var(--p-space-${gap === null || gap === void 0 ? void 0 : gap.lg})` : void 0,
    "--pc-tile-gap-xl": gap !== null && gap !== void 0 && gap.xl ? `var(--p-space-${gap === null || gap === void 0 ? void 0 : gap.xl})` : void 0,
    "--pc-tile-xs": formatColumns2(columns === null || columns === void 0 ? void 0 : columns.xs),
    "--pc-tile-sm": formatColumns2(columns === null || columns === void 0 ? void 0 : columns.sm),
    "--pc-tile-md": formatColumns2(columns === null || columns === void 0 ? void 0 : columns.md),
    "--pc-tile-lg": formatColumns2(columns === null || columns === void 0 ? void 0 : columns.lg),
    "--pc-tile-xl": formatColumns2(columns === null || columns === void 0 ? void 0 : columns.xl)
  };
  return import_react694.default.createElement("div", {
    className: styles124.Tiles,
    style
  }, children2);
};
function formatColumns2(columns) {
  if (!columns)
    return void 0;
...
var Toast2 = (0, import_react695.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const node = (0, import_react696.useRef)(null);
  const handleDismiss = (0, import_react696.useCallback)(({
    target
  }) => {
  ...
  return import_react696.default.createElement(import_react696.default.Fragment, null, visible ? import_react696.default.createElement(ScrollLock, null) : null, import_react696.default.createElement("div", {
    ref: node,
    className: classNames(styles127.SearchDismissOverlay, visible && styles127.visible),
...
function Search({
  ...
  const overlayMarkup = visible ? import_react697.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react697.default.createElement(import_react697.default.Fragment, null, overlayMarkup, import_react697.default.createElement("div", {
    className: classNames(styles126.Search, visible && styles126.visible)
  }, import_react697.default.createElement("div", {
    className: styles126.SearchContent
  }, import_react697.default.createElement("div", {
    className: styles126.Results
  }, children2))));
}
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react698.useState)(false);
  const input = (0, import_react698.useRef)(null);
  const searchId = useUniqueId("SearchField");
  const handleChange = (0, import_react698.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react698.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react698.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react698.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react698.default.createElement("button", {
    type: "button",
    "aria-label": i18n.translate("Polaris.TopBar.SearchField.clearButtonLabel"),
    className: styles128.Clear,
    onClick: handleClear,
    onBlur: () => {
  ...
  }, import_react698.default.createElement(Icon, {
    source: SvgCircleCancelMinor
  }));
  const className = classNames(styles128.SearchField, (focused || active || forceActive) && styles128.focused);
  return import_react698.default.createElement("div", {
    className,
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react698.default.createElement(VisuallyHidden, null, import_react698.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react698.default.createElement("input", {
    id: searchId,
    className: styles128.Input,
    placeholder,
    type: "search",
    autoCapitalize: "off",
    autoComplete: "off",
  ...
  }), import_react698.default.createElement("span", {
    className: styles128.Icon
  }, import_react698.default.createElement(Icon, {
    source: SvgSearchMinor
  })), clearMarkup, import_react698.default.createElement("div", {
    className: classNames(styles128.Backdrop, showFocusBorder && styles128.BackdropShowFocusBorder)
  }));
}
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react699.default.createElement("div", {
    className: styles130.MessageIndicator
  });
  return import_react699.default.createElement("div", {
    className: styles130.MessageIndicatorWrapper
...
function Message({
  ...
  const badgeMarkup = badge && import_react700.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  return import_react700.default.createElement("div", {
    className: styles132.Section
  }, import_react700.default.createElement(Popover2.Section, null, import_react700.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react700.default.createElement(TextContainer, null, import_react700.default.createElement(Heading, null, title, badgeMarkup), import_react700.default.createElement("p", null, description)), import_react700.default.createElement(Link, {
    url: to
  }, linkContent), import_react700.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react701.default.createElement(Message, {
    title: message.title,
  ...
  return import_react701.default.createElement(Popover2, {
    activator: import_react701.default.createElement("div", {
      className: styles131.ActivatorWrapper
    }, import_react701.default.createElement("button", {
      type: "button",
      className: styles131.Activator,
      onClick: onOpen,
      "aria-label": accessibilityLabel
    }, activatorContent)),
    active: open,
    ...
    preferredAlignment: "right"
  }, import_react701.default.createElement(ActionList, {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react702.default.createElement(import_react702.default.Fragment, null, import_react702.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react702.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react702.default.createElement("span", {
    className: styles129.Details
  }, import_react702.default.createElement("p", {
    className: styles129.Name
  }, name), import_react702.default.createElement("p", {
    className: styles129.Detail
  }, detail)));
  return import_react702.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const iconClassName = classNames(styles125.NavigationIcon, focused && styles125.focused);
  const navigationButtonMarkup = showNavigationToggle ? import_react703.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  }, import_react703.default.createElement("div", {
    className: styles125.IconWrapper
  ...
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react703.default.createElement("div", {
      className: styles125.ContextControl
    }, contextControl);
  } else if (logo) {
    const className = classNames(styles125.LogoContainer, showNavigationToggle || searchField ? styles125.LogoDisplayControl : styles125.LogoDisplayContainer, logoSuffix && styles125.hasLogoSuffix);
    contextMarkup = import_react703.default.createElement("div", {
      className
    }, import_react703.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles125.LogoLink,
      style: {
        width
      }
    }, import_react703.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
      className: styles125.Logo,
      style: {
        width
      }
    })), logoSuffix);
  }
  const searchMarkup = searchField ? import_react703.default.createElement(import_react703.default.Fragment, null, searchField, import_react703.default.createElement(Search, {
  ...
  return import_react703.default.createElement("div", {
    className: styles125.TopBar
  }, navigationButtonMarkup, contextMarkup, import_react703.default.createElement("div", {
    className: styles125.Contents
  }, import_react703.default.createElement("div", {
    className: styles125.SearchField
  }, searchMarkup), import_react703.default.createElement("div", {
    className: styles125.SecondaryMenu
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react704.default.createElement("p", {
    className: styles133.Timestamp
  }, import_react704.default.createElement(Stack, {
    alignment: "center",
    spacing: "extraTight"
  }, import_react704.default.createElement("span", {
    className: styles133.PlayIcon
  }, import_react704.default.createElement(Icon, {
    source: SvgPlayMinor
  })), import_react704.default.createElement(Text, {
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react704.default.createElement("div", {
      className: styles133.Progress
    }, import_react704.default.createElement("progress", {
      className: styles133.ProgressBar,
      value: progressValuePercents,
      max: "100"
    }), import_react704.default.createElement("div", {
      className: styles133.Indicator,
      style: {
        transform: `scaleX(${progressValue})`
      }
    }, import_react704.default.createElement("span", {
      className: styles133.Label
    }, progressValuePercents, "%")));
  }
  return import_react704.default.createElement("div", {
    className: styles133.ThumbnailContainer
  }, import_react704.default.createElement("div", {
    className: styles133.Thumbnail,
    style: {
      backgroundImage: `url(${thumbnailUrl})`
    }
  }), import_react704.default.createElement("button", {
    type: "button",
    className: styles133.PlayButton,
...
function useRowHovered() {
  const hovered = (0, import_react705.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react705.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react705.useContext)(ScrollContext);
